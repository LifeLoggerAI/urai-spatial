...
export default ({ onClick }: { onClick: () => void }) => {
    ...
    return <mesh ref={ref} onClick={onClick} castShadow><sphereGeometry args={[1.5, 64, 64]} /><meshStandardMaterial color="#3a2d6e" emissive="#7c6cff" emissiveIntensity={1.8} metalness={0.1} roughness={0.2} /></mesh>;
};
