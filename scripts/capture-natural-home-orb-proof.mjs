...
const receipt = {
  ...
  runtimeContract: 'v59-integrated-chamber-machine-home-real-glb-makehuman-orb-portal-semantic-and-visual-proof',
...
for (const spec of cases) {
  ...
  try {
    ...
    record.passed = record.status === 200
      ...
      && record.visualGrade === 'cinematic-pbr-v59-integrated-chamber-machine'
      && record.artRevision === 'v59-integrated-chamber-machine-candidate'
      && record.artCertification === 'v59-retained-pixel-candidate-not-certified'
