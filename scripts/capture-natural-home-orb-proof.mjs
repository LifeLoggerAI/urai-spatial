...
const receipt = {
  ...
  runtimeContract: 'v64-photogrammetry-orb-sanctuary-home-real-glb-makehuman-orb-portal-semantic-and-visual-proof',
...
for (const spec of cases) {
  ...
  try {
    ...
    record.passed = record.status === 200
      ...
      && record.visualGrade === 'cinematic-pbr-v64-photogrammetry-orb-sanctuary'
      && record.artRevision === 'v64-photogrammetry-orb-sanctuary-candidate'
      && record.artCertification === 'v64-retained-pixel-candidate-not-certified'
