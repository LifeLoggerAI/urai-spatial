...
const receipt = {
  ...
  runtimeContract: 'v62-asset-backed-service-vault-home-real-glb-makehuman-orb-portal-semantic-and-visual-proof',
...
for (const spec of cases) {
  ...
  try {
    ...
    record.passed = record.status === 200
      ...
      && record.visualGrade === 'cinematic-pbr-v62-asset-backed-service-vault'
      && record.artRevision === 'v62-asset-backed-service-vault-candidate'
      && record.artCertification === 'v62-retained-pixel-candidate-not-certified'
