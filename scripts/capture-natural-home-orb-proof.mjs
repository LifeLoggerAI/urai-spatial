...
const receipt = {
  ...
  runtimeContract: 'v63-authored-orb-sanctuary-home-real-glb-makehuman-orb-portal-semantic-and-visual-proof',
...
for (const spec of cases) {
  ...
  try {
    ...
    record.passed = record.status === 200
      ...
      && record.visualGrade === 'cinematic-pbr-v63-authored-orb-sanctuary'
      && record.artRevision === 'v63-authored-orb-sanctuary-candidate'
      && record.artCertification === 'v63-retained-pixel-candidate-not-certified'
