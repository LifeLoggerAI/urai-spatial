...
const receipt = {
  ...
  runtimeContract: 'v65-authored-chamber-orb-sanctuary-home-real-glb-makehuman-orb-portal-semantic-and-visual-proof',
...
for (const spec of cases) {
  ...
  try {
    ...
    record.passed = record.status === 200
      ...
      && record.visualGrade === 'cinematic-pbr-v65-authored-chamber-orb-sanctuary'
      && record.artRevision === 'v65-authored-chamber-orb-sanctuary-candidate'
      && record.artCertification === 'v65-retained-pixel-candidate-not-certified'
