...
const verificationPath = '.github/workflows/spatial-live-deploy.yml'
...
if (hasProductionCommand(verification)) failures.push(`${verificationPath} must remain verification-only`)
requireText(verification, 'This workflow performs verification only.', verificationPath)
requireText(verification, canonicalPath, verificationPath)
