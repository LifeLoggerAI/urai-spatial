...
const contracts = [
  ...
  ['/ground', [
    ...
    'first-person-lived-world-canon',
    'home-ground-shared-geology-v1',
    'eye-level-terrain-following',
    'terrain-slope-step-and-authored-obstacles',
    'terrain-rise-scanned-geology-before-safety-clamp',
  ], [
