// V72 exact-head authority: run the grouped proof against the current production telemetry.
...
const runtimeOwner = "result.animationOwner === 'v72-vertical-armored-ten-panel-orb-machine'"
