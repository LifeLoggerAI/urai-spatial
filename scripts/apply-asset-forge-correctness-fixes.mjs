...
patchFile('scripts/forge-launch-critical-assets.mjs', [
  {
...
patchFile('scripts/audit-launch-critical-artifact.mjs', [
  {
...
console.log('Asset forge correctness fixes applied.')
