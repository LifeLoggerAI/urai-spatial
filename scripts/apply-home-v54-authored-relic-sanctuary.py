...
home_state = replace_exact(home_state, "record.visibleWorld === 'moonlit-sacred-tech-sanctuary'", "record.visibleWorld === 'open-air-sacred-tech-reliquary'", 2, 'Home State current visible world')
