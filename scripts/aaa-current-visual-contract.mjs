...
const files = {
  ...
  ground: 'urai-tier1/src/app/GroundSpatialWorldCanon.tsx',
  groundRoute: 'urai-tier1/src/app/ground/page.tsx',
  groundControls: 'urai-tier1/src/app/ground/GroundAccessibleMovementControls.tsx',
...
const sourceChecks = [
  ...
  ['ground', 'ground', 'canonical first-person Ground owner', 'data-testid="urai-ground-lived-world"'],
  ['ground', 'ground', 'first-person exploration', 'data-ground-exploration="first-person"'],
  ['ground', 'ground', 'Home Ground continuity', 'home-ground-shared-geology-v1'],
  ['ground', 'ground', 'physical world readiness', 'data-ground-world-ready={worldReady'],
  ['ground', 'ground', 'summonable physical Orb', 'ground-summoned-physical-orb'],
  ['ground', 'ground', 'physical boundary treatment', 'terrain-rise-scanned-geology-before-safety-clamp'],
  ['ground', 'ground', 'mobile analog movement', 'Ground analog movement control'],
  ['ground', 'groundControls', '48px semantic movement parity', 'Ground first-person movement controls'],
  ['ground', 'groundRoute', 'canonical Ground route', 'home-ground-continuity-v1'],
