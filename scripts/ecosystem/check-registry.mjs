...
const requiredSystems = ['urai-spatial', 'asset-factory', 'urai-studio', 'firebase-hosting']
...
const report = {
  ...
  decision: missing.length === 0 ? 'V9_ECOSYSTEM_REGISTRY_READY' : 'V9_ECOSYSTEM_REGISTRY_INCOMPLETE',
