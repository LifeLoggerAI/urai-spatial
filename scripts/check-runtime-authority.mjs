...
requireIncludesAny('urai-tier1/src/scene/HomeScene.tsx', ['data-testid="urai-home-activation"', 'data-testid="urai-sky-click-target"', 'onClick={isHomeMode ? enterLifeMap : undefined}'], 'canonical Home entry activation')
requireIncludes('urai-tier1/src/scene/HomeScene.tsx', 'isHomeMode ? <Orb state="idle" /> : null', 'silent Home orb world object')
