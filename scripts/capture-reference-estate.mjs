...
const simple = [
  ...
  { id:'LEGACY-001', system:'Legacy', state:'entry-establishing', route:'/legacy?legacyReview=entry', marker:'[data-legacy-review-state="entry"]' },
  { id:'LEGACY-002', system:'Legacy', state:'aisle-exploration', route:'/legacy?legacyReview=exploration', marker:'[data-legacy-review-state="exploration"]' },
  ...
  { id:'LEGACY-010', system:'Legacy', state:'semantic-fallback', route:'/legacy', text:'Three-dimensional rendering is unavailable on this device.', noWebGL:true },

  { id:'COUNCIL-001', system:'Council', state:'chamber-overview', route:'/council?councilReview=overview', marker:'[data-council-review-state="overview"]' },
  { id:'COUNCIL-002', system:'Council', state:'observer', route:'/council?councilReview=observer', marker:'[data-council-review-state="observer"]' },
  { id:'COUNCIL-003', system:'Council', state:'select-participant', route:'/council?councilReview=selected', marker:'[data-council-review-state="selected"]' },
  { id:'COUNCIL-004', system:'Council', state:'listening', route:'/council?councilReview=listening', marker:'[data-council-review-state="listening"]', text:'REFERENCE REVIEW — listening / turn ownership.' },
  ...
  { id:'COUNCIL-012', system:'Council', state:'reduced-motion', route:'/council?councilReview=listening', marker:'[data-council-review-state="listening"]', reducedMotion:true },
  { id:'COUNCIL-013', system:'Council', state:'reduced-stimulation', route:'/council?councilReview=reduced-stimulation', marker:'[data-council-review-state="reduced-stimulation"]' },
  { id:'COUNCIL-014', system:'Council', state:'semantic-fallback', route:'/council', text:'Three-dimensional rendering is unavailable on this device.', noWebGL:true },
