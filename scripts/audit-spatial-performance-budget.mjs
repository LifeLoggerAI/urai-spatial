...
requireMatch('Active cosmic Life Map render-proof canonical function', lifeMap, /function RenderProof\(\)/)
requireMatch('Active cosmic Life Map render-proof thresholds', lifeMap, /gl\.info\.render\.calls > 0 && objects > 20 && anchors >= 8/)
requireMatch('Active cosmic Life Map render-proof mounted in authored world', lifeMap, /<RenderProof \/>/)
