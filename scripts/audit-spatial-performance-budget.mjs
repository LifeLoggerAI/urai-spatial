...
requireMatch('Life Map boundary preserves one stable adaptive scene', boundary, /<AdaptiveLifeMapScene\s*\/>/)
requireMatch('Life Map boundary mounts route-owned semantic navigation', boundary, /<LifeMapSemanticNavigator\s*\/>/)
