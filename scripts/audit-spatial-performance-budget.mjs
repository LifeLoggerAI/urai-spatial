...
requireMatch('Active cosmic Life Map render-proof full-world defaults', lifeMap, /function RenderProof\(\{ minObjects = 20, minAnchors = 8 \}/)
requireMatch('Active cosmic Life Map render-proof parameterized thresholds', lifeMap, /gl\.info\.render\.calls > 0 && objects > minObjects && anchors >= minAnchors/)
requireMatch('Active cosmic Life Map full-world proof uses default thresholds', lifeMap, /<RenderProof \/>/)
