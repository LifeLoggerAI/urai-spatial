...
const routeOwnerChecks = [
  {
    ...
    renderMode: 'hybrid-procedural-with-provider-context',
    assetSet: 'homeAssets',
    required: [
    ...
    forbidden: ['FinalHomeWorld from', 'data-home-visible-world="final-physical-sanctuary-memory-rooms"'],
  },
  {
    routes: ['/ground'],
    files: [
