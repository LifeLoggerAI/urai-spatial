...
const routeOwnerChecks = [
  ...
  {
    routes: ['/focus'],
    files: ['urai-tier1/src/app/focus/FocusChamberClient.tsx'],
    renderMode: 'selected-memory-star-spatial',
    required: [
      ...
      'URAI Focus selected memory star',
      '<Canvas',
    ],
    forbidden: ['assetCssStack(focusAssets.', 'Selected memory chamber'],
  },
