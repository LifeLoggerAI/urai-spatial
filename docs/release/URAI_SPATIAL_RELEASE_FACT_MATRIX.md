...
| Current `main` HEAD | confirmed | `a572188d61887275f8ce88e186bb554f30d9d903` | GitHub API verification |
| Working release candidate SHA | proposed, ready to lock | `a572188d61887275f8ce88e186bb554f30d9d903` | Matches current known `main` HEAD; invalid if a newer HEAD or owner-approved SHA supersedes it |
...
4. Explicit owner confirmation that the working SHA should be locked
