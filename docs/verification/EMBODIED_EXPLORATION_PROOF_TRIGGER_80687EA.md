# Embodied Exploration Verification Trigger
...
- The repaired product retains one authored visible Home Orb, an invisible physical approach target, and a mounted transparent semantic travel controller.
- Direct Home travel labels are declarative; the runtime layer performs no imperative accessibility-label mutation.
- Any accepted evidence must record both this verification SHA and the product-tree SHA above.
