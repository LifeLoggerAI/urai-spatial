...
|---|---|---|---|---|
| REF-HOME-001 | Home presentation | desktop hero, mobile portrait, reduced-motion, day/night/weather where current runtime supports them | CANDIDATE | Current exact-head pixels opened and accepted |
...
| REF-FPHOME-001 | First-person Home | desktop/mobile layout, camera height/FOV, Orb/Passport/Earth spatial relationships, no-body proof | CANDIDATE | Exact-head bodyless FP captures accepted |
