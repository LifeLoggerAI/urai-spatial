...
- Exact current SHA authority is maintained outside the commit tree in PR #952 and the canonical Drive receipt to avoid self-invalidating documentation commits.
