# UrAi Home finalization authority — 2026-07-23

## Canonical authority

- Repository: `LifeLoggerAI/urai-spatial`
- Application root: `urai-tier1`
- Base: `main@748e50398d85effeaa4ed17aaf78d4076dddbb45`
- Branch: `feat/home-final-personalized-sanctuary-20260723`
...
- Exact current PR head is maintained in PR #952 and the canonical Drive execution receipt; this repository document intentionally avoids a self-invalidating current-SHA field.
...
Only `explicit-sample` may consume deterministic sample fixtures. Every visible memory place or environmental response must carry source/provenance and a user-facing explanation path.
