...
Repository role: **canonical public spatial/product runtime**
...
- Current exact-head PR/runtime evidence outranks stored cross-system snapshots.
- Home/Focus/Replay/Memory Star literal canon may not be weakened by ecosystem marketing docs.
- Hardware XR support requires physical device proof.
