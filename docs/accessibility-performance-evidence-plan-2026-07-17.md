...
Base authority: `63cd8885bf3b09c8d42aace7d36edd1689e22d3c`
Branch: `feat/accessibility-performance-evidence-20260717`

## Scope

This lane owns diagnostics, isolated tests, evidence manifests, performance budgets, browser/device verification instructions, and non-route accessibility utilities. It does not own `GroundGateway`, `FocusChamberClient`, `PersistentWorldCompanion`, route navigation, release workflows, deployment, rollback, credentials, DNS, billing, or production state.
