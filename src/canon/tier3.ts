...
export const TIER3_FEATURE_CANON: Tier3FeatureCanonEntry[] = [
  {
    ...
    owningTier: 'tier3',
    route: '/',
    component: 'TierOneExperience',
    dataRequirements: ['No production mock user data; launch copy is static canon content only'],
    interactionStates: ['first-load', 'home-to-life-map', 'keyboard-enter', 'reduced-motion'],
    accessibilityRequirements: ['labeled primary navigation', 'keyboard path', 'screen-reader-safe scene label'],
    testRequirements: ['home invariant', 'spatial E2E', 'no console error audit'],
    productionReadinessStatus: 'locked',
  },
  {
    ...
    owningTier: 'tier3',
    route: '/life-map',
    component: 'LifeMapClient',
    dataRequirements: ['User-owned memories or explicit launch-demo owner boundary'],
    interactionStates: ['route-transition', 'desktop-pointer', 'mobile-touch', 'empty-state'],
    accessibilityRequirements: ['focusable navigation controls', 'ARIA scene status', 'escape recovery'],
    testRequirements: ['LifeMap unit tests', 'spatial hardening E2E'],
    productionReadinessStatus: 'locked',
  },
  {
    ...
    testRequirements: ['focus route smoke', 'spatial lock E2E'],
    productionReadinessStatus: 'locked',
  },
  {
    ...
    interactionStates: ['focus-to-replay', 'replay-to-unwind', 'success-complete'],
    accessibilityRequirements: ['playback labels', 'keyboard continue path', 'no forced motion'],
    testRequirements: ['replay Tier-5 lock', 'spatial lock E2E'],
    productionReadinessStatus: 'locked',
  },
  {
    ...
    owningTier: 'tier3',
    route: '/unwind',
    component: 'Unwind route surface',
    dataRequirements: ['No telemetry write without consent boundary'],
    interactionStates: ['replay-to-unwind', 'back-to-safe-state', 'escape-recovery'],
    accessibilityRequirements: ['clear recovery action', 'keyboard route back', 'screen-reader calm state'],
    testRequirements: ['route exposure check', 'spatial E2E unwind/back coverage'],
    productionReadinessStatus: 'locked',
  },
]
