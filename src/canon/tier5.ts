...
export const tier5: CanonTier = {
  id: 'Tier-5',
  officialLabel: 'Tier-5 Canon',
  purpose: 'LOCS Tier-5 governance for URAI Spatial.',
  ...
  protectedPhrases: ['Tier-5', 'LOCS', 'URAI Spatial Canon'],
  protectedFiles: ['docs/canon/TIER_5_CANON_STANDARDS.md', 'src/canon/tier5.ts'],
