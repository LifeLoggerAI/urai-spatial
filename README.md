...
- Current release lane: exact-head Genesis convergence
...
No old CI result, screenshot, visual acceptance, PR description, or steward attestation transfers to a successor SHA. The current PR head must earn its own release evidence.
