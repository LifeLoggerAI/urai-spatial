...
test('Orb ownership follows destination canon without visual duplication', () => {
  ...
  assert.match(homeProduction, /v71-continuous-armored-ovoid-ten-panel-machine/)
  assert.match(homeProduction, /data-home-animation-owner="v71-continuous-armored-ten-panel-orb-machine"/)
  assert.doesNotMatch(homeProduction, /function Beam\(|function StoneMass\(|octahedronGeometry|icosahedronGeometry|torusGeometry|capsuleGeometry/)
  ...
  assert.doesNotMatch(homeProduction, /<GovernedModel|name="home-only-companion"/)
  assert.doesNotMatch(homeProduction, /RoundedBox|#37e5ff|#48dfff|#6cf4ff/i)
