...
test('V212 remains reproducible historical authority while current runtime stays on stellar Memory Stars', () => {
  ...
  assert.doesNotMatch(source, /life-map-production\/authored-v212\/life-map-memory-sanctuary-v212\.glb/)
