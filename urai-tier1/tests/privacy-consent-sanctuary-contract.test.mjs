...
test('Consent Sanctuary is spatial and remains directly operable', () => {
  ...
  assert.match(client, /data-launch-surface="premium-privacy-consent-console"/)
  assert.match(css, /\.consentSanctuary\{position:fixed;inset:0;width:100%;height:100svh/)
  assert.match(css, /overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain/)
