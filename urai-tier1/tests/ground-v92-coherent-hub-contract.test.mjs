...
test('Ground renders the current atmospheric lived world instead of the rejected root-vault substrate', () => {
  ...
  assert.match(ground, /visibleAuthority: "runtime-authored-canopy-v28"/)
  assert.match(ground, /supersedesVisibleCandidate: "ground-v27-laned-canopy-rock-tile-microdetail"/)
  assert.match(ground, /literalPixelRepair: "v28-organic-canopy-layout-procedural-soil-no-paving"/)
