...
test('Ground renders the current atmospheric lived world instead of the rejected root-vault substrate', () => {
  ...
  assert.match(ground, /visibleAuthority: "runtime-authored-canopy-v27"/)
  assert.match(ground, /supersedesVisibleCandidate: "ground-v26-sparse-open-crown"/)
  assert.match(ground, /literalPixelRepair: "v27-layered-foliage-textured-soil-natural-depth"/)
  assert.match(ground, /slice\(0, woodland \? 28 : 24\)/)
