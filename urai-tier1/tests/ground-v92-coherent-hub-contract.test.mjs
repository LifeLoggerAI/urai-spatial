...
test('Ground renders the current atmospheric lived world instead of the rejected root-vault substrate', () => {
  ...
  assert.match(ground, /supersedesVisibleCandidate: "ground-v25-oversized-dense-leaflet-crown"/)
  assert.match(ground, /literalPixelRepair: "v26-fine-scale-leaflets-natural-soil-open-atmosphere"/)
