...
test('Ground renders the current atmospheric lived world instead of the rejected root-vault substrate', () => {
  ...
  assert.match(ground, /visibleAuthority: "runtime-authored-canopy-v23"/)
  assert.match(ground, /supersedesVisibleCandidate: "ground-natural-canopy-v3-low-poly-silhouette"/)
  assert.match(ground, /literalPixelRepair: "v23-volumetric-foliage-mature-canopy-natural-atmosphere"/)
