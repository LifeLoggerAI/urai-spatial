...
test('Ground renders the current atmospheric lived world instead of the rejected root-vault substrate', () => {
  ...
  assert.match(ground, /const FERN_DIFFUSE = "\/assets\/urai\/home-production\/cc0\/polyhaven-v48\/fern_02\/textures\/fern_02_diff_1k\.jpg"/)
  assert.match(ground, /const FERN_ALPHA = "\/assets\/urai\/home-production\/cc0\/polyhaven-v48\/fern_02\/textures\/fern_02_alpha_1k\.png"/)
  assert.match(ground, /alphaMap=\{alphaMap\}/)
  assert.match(ground, /alphaTest=\{0\.42\}/)
