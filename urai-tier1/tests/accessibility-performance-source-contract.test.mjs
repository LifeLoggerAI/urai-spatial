...
test('accessibility and performance implementation contracts are present', () => {
  ...
  requireText(homeRuntime, 'data-camera-gesture-boundary="independent"')
  requireText(homeRuntime, 'touch-action: manipulation;')
  requireText(finalHome, 'name="home-final-orb-physical-anchor"')
