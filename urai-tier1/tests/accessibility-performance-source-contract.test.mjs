...
test('accessibility and performance implementation contracts are present', () => {
  ...
  assert.doesNotMatch(homeCanvas, /emissiveIntensity=\{hovered|name="home-only-companion"/, 'Home must not render a second visible WebGL Orb beside the authored sanctuary Orb')
