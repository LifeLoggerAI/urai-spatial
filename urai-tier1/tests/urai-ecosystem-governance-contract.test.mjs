...
test('ecosystem registry is exact-stack bound, fail-closed, and names every governed identity', () => {
  ...
  assert.equal(registry.stackedBaseCommit, '0432a5aeac4e153e801bff91b64cc968234473ec')
  ...
  assert.equal(registry.dependencies.consentGatedGeography.pullRequest, 1020)
  assert.equal(registry.dependencies.consentGatedGeography.exactHead, '0432a5aeac4e153e801bff91b64cc968234473ec')
