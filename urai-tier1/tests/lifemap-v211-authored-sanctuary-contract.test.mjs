...
test('V211 source authority remains reproducible while the current galaxy keeps it historical', () => {
  ...
  assert.doesNotMatch(currentRuntime, /life-map-production\/authored-v211\/life-map-memory-sanctuary-v211\.glb|continuous-eroded-memory-sanctuary/)
