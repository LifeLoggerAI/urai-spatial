...
test('persistent world navigation preserves canonical ownership and separate hit targets', () => {
  ...
  assert.match(finalCss, /\.urai-final-home-doorways,[\s\S]*touch-action: manipulation !important/)
  assert.match(finalCss, /@media \(min-width: 761px\)[\s\S]*\.urai-final-home-doorways[\s\S]*bottom: max\(96px/)
  assert.match(finalCss, /@media \(max-width: 760px\)[\s\S]*\.urai-final-home-doorways[\s\S]*bottom: max\(112px/)
