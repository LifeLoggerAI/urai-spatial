...
test('persistent world navigation preserves canonical ownership and separate hit targets', () => {
  ...
  assert.match(finalCss, /\.urai-home-spatial-runtime-layer \{[\s\S]*z-index: 2147482400 !important/)
  assert.match(worldNavigation, /\.urai-world-transition \{[\s\S]*z-index: 2147482500;[\s\S]*pointer-events: none;/)
