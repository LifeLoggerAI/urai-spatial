...
test('HomeScene keeps Home, Ascent, and Life Map visual authority separate', () => {
  ...
  assert.match(source, /showHomeWorld \? <Ground groundTier=\{HOME_VISUAL_TIERS\.ground\} reducedMotion=\{reducedMotion\} \/> : null/)
  assert.match(source, /isHomeMode \? <Orb state="idle" \/> : null/)
