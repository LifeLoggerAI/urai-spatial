...
test('app template mounts the exact active V223 Home production owner without certified-route redirects', () => {
  ...
  assert.match(assetHome, /data-home-v223-retained-pixel-rebuild="active"/)
  ...
  assert.match(assetHome, /world\.setAttribute\('data-home-v223-art-layer', 'continuous-stratified-weathered-terrain-integrated-destinations-open-cleft-living-memory-presence'\)/)
