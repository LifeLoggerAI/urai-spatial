...
test('app template mounts the exact active V224 Home production owner without certified-route redirects', () => {
  ...
  assert.match(assetHome, /data-home-v224-retained-pixel-rebuild="active"/)
  ...
  assert.match(assetHome, /world\.setAttribute\('data-home-v224-art-layer', 'direct-runtime-sculpted-sanctuary-overhanging-strata-rooted-memory-ribs-open-ground-sculptural-life-map-asymmetric-living-memory-presence'\)/)
  ...
  assert.match(activeHomeGeometry, /home-v224-sculpted-sanctuary-floor/)
  assert.match(activeHomeGeometry, /home-v224-rooted-memory-rib/)
  assert.match(activeHomeGeometry, /home-v201-single-connected-folded-living-memory-mantle/)
