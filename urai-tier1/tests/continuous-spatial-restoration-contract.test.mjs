...
test('current living-memory boundary preserves V291 interaction semantics and historical source separately', () => {
  has(visualAuthority, 'Current Home Orb visual authority boundary')
  has(visualAuthority, 'The living-memory runtime owns its translucent shell')
  ...
  has(renderer, "visualAuthority: 'living-memory-translucent-heart'")
