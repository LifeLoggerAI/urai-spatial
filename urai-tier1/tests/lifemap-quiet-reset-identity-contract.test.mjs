...
const cosmic = read('src/components/lifemap/CosmicComposedLifeMapScene.tsx')
...
test('selected Life Map mode resolves exact node identity into Focus and Replay on the mounted cosmic owner', () => {
