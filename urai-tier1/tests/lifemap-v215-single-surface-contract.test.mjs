...
test('Focus formation stays grounded in the authored chamber and current connected CLOSED memory scar while Replay preserves readable organic-edged media', () => {
  ...
  assert.match(geology, /focusLiteralPixelSuccessorV297 = 'v297-off-axis-s-fracture-shallow-meandering-furrow-one-dominant-lip-portrait-legibility'/)
  assert.match(geology, /focusCurrentVisualAuthority = 'v297-off-axis-continuous-ground-held-memory-rupture'/)
