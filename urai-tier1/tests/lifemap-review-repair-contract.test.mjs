...
test('Focus final composition preserves one connected living-memory authority and locks the V299 sanctuary fissure', () => {
  ...
  assert.match(focusGeology, /focusLiteralPixelSuccessorV299 = 'v299-ground-grade-dark-mineral-fissure-readable-footprint-warm-broken-lip-no-blue-object'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v299-ground-grade-dark-mineral-memory-fissure'/)
