...
test('Focus final composition preserves one connected living-memory authority and locks the V300 terrain-seated sanctuary fissure', () => {
  ...
  assert.match(focusGeology, /V300 responds to exact V299 pixels/)
  ...
  assert.match(focusGeology, /const x = 1\.92 \* t/)
  assert.match(focusGeology, /const z = -1\.23 \* t/)
  ...
  assert.match(focusGeology, /focusLiteralPixelSuccessorV300 = 'v300-terrain-seated-continuous-dark-mineral-fissure-desktop-portrait-no-islands'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v300-terrain-seated-continuous-memory-fissure'/)
