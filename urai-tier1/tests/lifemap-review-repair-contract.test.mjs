...
test('Focus final composition preserves one connected living-memory authority and locks the V292 sanctuary fracture', () => {
  ...
  assert.match(focusGeology, /V292 removes the remaining object read/)
  assert.match(focusGeology, /const MEMORY_SECTIONS = 21/)
  ...
  assert.match(focusGeology, /v292-ground-intersecting-longitudinal-fracture-with-deep-furrow/)
  ...
  assert.match(focusGeology, /const terminalBurial = THREE\.MathUtils\.smoothstep\(Math\.abs\(t\), \.62, 1\)/)
  assert.match(focusGeology, /const centralScar = Math\.exp/)
  assert.match(focusGeology, /const nearRidge = Math\.exp/)
  assert.match(focusGeology, /const farRidge = Math\.exp/)
  assert.match(focusGeology, /const brokenKnot = Math\.exp/)
  assert.match(focusGeology, /const centerX = 2\.55 \* t/)
  assert.match(focusGeology, /const centerY = -1\.48/)
  assert.match(focusGeology, /- \.34 \* terminalBurial/)
  assert.match(focusGeology, /const undersideSink = Math\.max\(0, -Math\.cos\(angle\)\)/)
  assert.match(focusGeology, /const edgeSink = terminalBurial/)
  assert.match(focusGeology, /positions\.push\(-2\.70, -1\.98, \.52\)/)
  assert.match(focusGeology, /positions\.push\(2\.67, -1\.99, -\.60\)/)
  assert.match(focusGeology, /v292-shallow-ground-fracture-buried-ends-broken-scar-lips-no-closed-arch/)
  assert.match(focusGeology, /focusVisualAuthority = 'v292-sanctuary-memory-fracture'/)
