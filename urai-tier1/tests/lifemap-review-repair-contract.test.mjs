...
test('Focus final composition preserves one connected living-memory authority and locks the V320 readable localized three-cavity-bottom terrain-owned sanctuary fissure', () => {
  ...
  assert.match(focusSource, /focus-v321-focal-readable-three-radial-pressure-cavity-bottoms/)
  ...
  assert.match(focusGeology, /focusLiteralPixelSuccessorV321 = 'v321-focal-readable-separated-radial-cavities-subordinate-hairline-connector'/)
  assert.match(focusGeology, /focusIncisionAuthority = 'v321-focal-readable-localized-near-black-cavity-bottoms-ground-blended-subordinate-hairline-connector'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v321-focal-readable-three-radial-terrain-cavities-localized-bottoms-ground-blended-hairline-connector-buried-closed-body'/)
