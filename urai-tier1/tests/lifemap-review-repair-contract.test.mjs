...
test('Focus final composition preserves one connected living-memory authority and locks the V291 ground-fused seam', () => {
  ...
  assert.match(focusGeology, /V291 removes the portable-object silhouette/)
  ...
  assert.match(focusGeology, /const terminalBurial = THREE\.MathUtils\.smoothstep\(Math\.abs\(t\), \.56, 1\)/)
  ...
  assert.match(focusGeology, /const centerX = 1\.44 \* t/)
  assert.match(focusGeology, /const centerY = -1\.34/)
  assert.match(focusGeology, /- \.54 \* terminalBurial/)
  assert.match(focusGeology, /const edgeSink = terminalBurial/)
  assert.match(focusGeology, /positions\.push\(-1\.48, -1\.93, \.34\)/)
  assert.match(focusGeology, /positions\.push\(1\.45, -1\.94, -\.47\)/)
  assert.match(focusGeology, /v291-ground-fused-memory-seam-submerged-terminals-nonportable-scar-ridges/)
  assert.match(focusGeology, /focusVisualAuthority = 'v291-ground-fused-memory-seam'/)
