...
test('Focus final composition gives one connected living-memory fold pixel authority and locks the V282 anti-ribbon structure', () => {
  ...
  assert.match(focusGeology, /v281-dominant-central-fold-dual-tension-waists-lifted-curl-downback-tuck-oblique-ridge/)
  assert.match(focusGeology, /v282-compressed-terminal-tucks-volumetric-knees-central-depth-no-ribbon-tips/)
  assert.match(focusGeology, /V282 compresses those terminal gestures/)
  ...
  assert.match(focusGeology, /\+ \.195 \* leadingTuck/)
  assert.match(focusGeology, /\+ \.275 \* spineKnot/)
  assert.match(focusGeology, /- \.205 \* counterTuck/)
  assert.match(focusGeology, /- \.34 \* leadingWaist/)
  assert.match(focusGeology, /- \.32 \* counterWaist/)
  assert.match(focusGeology, /\+ \.39 \* spineKnot/)
  assert.match(focusGeology, /const depth = \.030 \+ endTaper/)
  assert.match(focusGeology, /const ridgeLift = \.116 \* endTaper \* ridge/)
  assert.match(focusGeology, /const creaseSink = \.070 \* endTaper \* furrow/)
  assert.match(focusGeology, /const pinch = Math\.max\(\.46,/)
