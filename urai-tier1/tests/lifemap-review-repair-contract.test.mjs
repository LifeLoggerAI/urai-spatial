...
test('Focus final composition preserves one connected living-memory authority and locks the V306 broken-earth ground-owned sanctuary fissure', () => {
  ...
  assert.match(focusGeology, /focusIncisionAuthority = 'v306-broken-earth-footprint-attached-microbranches-sparse-weathered-edge'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v306-ground-owned-broken-earth-fissure-buried-closed-body'/)
