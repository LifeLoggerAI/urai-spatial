...
test('Focus final composition preserves one connected living-memory authority and locks the V297 sanctuary scar', () => {
  ...
  assert.match(focusGeology, /V297 responds to the literal V296 retained pixels/)
  assert.match(focusGeology, /const MEMORY_SECTIONS = 41/)
  ...
  assert.match(focusGeology, /const x = 2\.62 \* t/)
  assert.match(focusGeology, /const z = -\.92 \* t/)
  assert.match(focusGeology, /const terminalSink = THREE\.MathUtils\.smoothstep\(Math\.abs\(t\), \.72, 1\) \* \.28/)
  ...
  assert.match(focusGeology, /const centerY = -1\.205/)
  assert.match(focusGeology, /const furrowCenter =/)
  assert.match(focusGeology, /const furrow = Math\.exp/)
  assert.match(focusGeology, /const leftLipCenter =/)
  assert.match(focusGeology, /const rightLipCenter =/)
  assert.match(focusGeology, /const leftLip = Math\.exp/)
  assert.match(focusGeology, /const rightLip = Math\.exp/)
  assert.match(focusGeology, /const continuityLift = interiorWindow/)
  assert.match(focusGeology, /const depthWarp =/)
  ...
  assert.match(focusGeology, /Long side walls close the two lateral boundaries/)
  assert.match(focusGeology, /Both terminal caps are below grade and complete the watertight manifold/)
  assert.match(focusGeology, /one-closed-ground-owned-scar-no-split-pair-no-portable-outline/)
  assert.match(focusGeology, /focusLiteralPixelSuccessorV297 = 'v297-off-axis-s-fracture-shallow-meandering-furrow-one-dominant-lip-portrait-legibility'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v297-off-axis-continuous-ground-held-memory-rupture'/)
