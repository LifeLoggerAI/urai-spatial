...
test('Focus final composition preserves one connected living-memory authority and locks the V305 jagged ground-owned sanctuary fissure', () => {
  ...
  assert.match(focusSource, /focus-v305-ground-owned-fissure/)
  ...
  assert.match(focusGeology, /focusIncisionAuthority = 'v305-coplanar-jagged-width-modulated-ground-fissure'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v305-ground-owned-jagged-fissure-buried-closed-body'/)
