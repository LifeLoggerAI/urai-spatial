...
test('Focus final composition preserves one connected living-memory authority and locks the V295 sanctuary scar', () => {
  ...
  assert.match(focusGeology, /const z = -\.54 \* t/)
  assert.match(focusGeology, /const terminalSink = THREE\.MathUtils\.smoothstep\(Math\.abs\(t\), \.72, 1\) \* \.24/)
  ...
  assert.match(focusGeology, /const centerY = -1\.225/)
  ...
  assert.match(focusGeology, /positions\.push\(positions\[i\], positions\[i \+ 1\] - \.16, positions\[i \+ 2\]\)/)
  ...
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v295-closed-continuous-ground-held-memory-rupture'/)
