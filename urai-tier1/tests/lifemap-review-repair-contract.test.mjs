...
test('Focus final composition gives one connected living-memory fold pixel authority and locks the V281 anti-creature structure', () => {
  ...
  assert.match(focusGeology, /V281 therefore makes the fold itself/)
  assert.match(focusGeology, /const leadingWaist = Math\.exp/)
  assert.match(focusGeology, /const counterWaist = Math\.exp/)
  assert.match(focusGeology, /\+ \.305 \* leadingCurl/)
  assert.match(focusGeology, /\+ \.245 \* spineKnot/)
  assert.match(focusGeology, /- \.285 \* counterTuck/)
  assert.match(focusGeology, /- \.40 \* leadingWaist/)
  assert.match(focusGeology, /- \.38 \* counterWaist/)
  assert.match(focusGeology, /\+ \.34 \* spineKnot/)
  assert.match(focusGeology, /const ridgeLift = \.108 \* endTaper \* ridge/)
  assert.match(focusGeology, /const creaseSink = \.066 \* endTaper \* furrow/)
  assert.match(focusGeology, /const pinch = Math\.max\(\.47,/)
