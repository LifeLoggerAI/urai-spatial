...
test('Focus final composition gives one connected living-memory fold pixel authority and locks the V283 compact anti-tent structure', () => {
  ...
  assert.match(focusGeology, /v282-compressed-terminal-tucks-volumetric-knees-central-depth-no-ribbon-tips/)
  assert.match(focusGeology, /v283-compact-offcenter-knot-thick-terminals-tucked-underfold-no-tent-manta/)
  assert.match(focusGeology, /V283 deliberately removes that broad sheet silhouette/)
  assert.match(focusGeology, /const leadingTuck = Math\.exp/)
  assert.match(focusGeology, /const leadingKnee = Math\.exp/)
  assert.match(focusGeology, /const leadingWaist = Math\.exp/)
  assert.match(focusGeology, /const spineKnot = Math\.exp\(-Math\.pow\(\(t \+ \.13\)/)
  assert.match(focusGeology, /const underFold = Math\.exp/)
  assert.match(focusGeology, /const counterWaist = Math\.exp/)
  assert.match(focusGeology, /const counterKnee = Math\.exp/)
  assert.match(focusGeology, /const counterTuck = Math\.exp/)
  assert.match(focusGeology, /const centerX = t \* \.94/)
  assert.match(focusGeology, /\+ \.215 \* spineKnot/)
  assert.match(focusGeology, /- \.145 \* underFold/)
  assert.match(focusGeology, /- \.275 \* underFold/)
  assert.match(focusGeology, /const height = \.052 \+ endTaper/)
  assert.match(focusGeology, /const depth = \.058 \+ endTaper/)
  assert.match(focusGeology, /\+ \.148 \* spineKnot/)
  assert.match(focusGeology, /\+ \.118 \* underFold/)
  assert.match(focusGeology, /const ridgeLift = \.122 \* endTaper \* ridge/)
  assert.match(focusGeology, /const creaseSink = \.074 \* endTaper \* furrow/)
  assert.match(focusGeology, /const pinch = Math\.max\(\.48,/)
