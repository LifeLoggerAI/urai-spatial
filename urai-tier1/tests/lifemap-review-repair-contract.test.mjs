...
test('Focus final composition preserves one connected living-memory authority and locks the V298 sanctuary scar', () => {
  ...
  assert.match(focusGeology, /V297 removed the split-pair read/)
  assert.match(focusGeology, /V298 therefore changes silhouette and/)
  ...
  assert.match(focusGeology, /const x = 1\.56 \* t/)
  assert.match(focusGeology, /const z = -1\.02 \* t/)
  assert.match(focusGeology, /const terminalSink = THREE\.MathUtils\.smoothstep\(Math\.abs\(t\), \.66, 1\) \* \.34/)
  ...
  assert.match(focusGeology, /const centerY = -1\.255/)
  ...
  assert.match(focusGeology, /focusLiteralPixelSuccessorV298 = 'v298-narrow-short-deep-incision-broken-dominant-lip-counter-side-buried-no-panel'/)
  assert.match(focusGeology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(focusGeology, /focusCurrentVisualAuthority = 'v298-narrow-broken-ground-held-memory-scar'/)
