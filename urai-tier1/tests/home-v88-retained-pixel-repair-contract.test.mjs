...
test('V124 finalization executes this contract and checks the complete current source markers', () => {
  ...
  assert.match(finalizer, /home-v124-\$\{destination\}-portal-port-natural-shoulder/)
  assert.match(finalizer, /home-v124-\$\{destination\}-portal-starboard-natural-shoulder/)
