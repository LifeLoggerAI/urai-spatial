...
test('portrait travel retains visual density without taking interaction ownership', () => {
  ...
  assert.match(density, /data-life-map-phase='departure'\] canvas\{transform:scale\(1\.5\)!important;transform-origin:40% 61%!important\}/)
  assert.match(density, /data-life-map-phase='travel'\] canvas\{transform:scale\(2\.9\)!important;transform-origin:40% 61%!important\}/)
