...
const homeWorld = read('src/spatial/layout/HomeWorldProductionV70.tsx')
...
test('production audio remains consent-controlled on the live final Home owner', () => {
  ...
  assert.match(homeWorld, /data-home-visible-world="v70-deep-photogrammetry-industrial-reliquary"/)
