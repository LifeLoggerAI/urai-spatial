...
assert.match(focusClient, /Enter Replay for/, "Final Focus star must expose the canonical accessible Enter Replay action.");
...
assert.match(focusClient, /data-focus-spatial="selected-memory-star"/, "Final Focus must expose the selected Memory Star spatial contract.");
assert.match(focusClient, /data-focus-composition="selected-memory-star-with-contained-memory"/, "Final Focus must make the selected Memory Star the composition owner.");
assert.match(focusClient, /data-focus-terrain-owner="false"/, "Final Focus must explicitly reject terrain ownership.");
assert.match(focusClient, /<OrbitControls/, "Final Focus star must retain bounded pointer and touch exploration.");
