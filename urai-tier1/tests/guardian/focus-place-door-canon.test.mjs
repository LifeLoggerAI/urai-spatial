...
assert.match(focusClient, /if \(!memory \|\| !replayHref \|\| committed\) return/, "Final Focus chamber must fail closed and debounce Replay when no authorized memory exists or travel is committed.");
