...
test('V210 source authority is reproducible and camera-native without predecessor scaling', () => {
  assert.match(source, /life-map-production\/authored-v210\/life-map-memory-sanctuary-v210\.glb/)
  assert.match(source, /name="life-map-v210-blender-authored-memory-sanctuary"/)
