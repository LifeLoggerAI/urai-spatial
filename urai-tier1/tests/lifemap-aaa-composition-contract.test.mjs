...
test('authored animation clips honor reduced motion with stable readable poses', () => {
  ...
  assert.match(star, /name=\{\`life-map-stellar-memory-\$\{siteKey\}\`\}/)
  assert.match(star, /name="memory-star-photosphere"/)
  assert.match(star, /name="memory-star-corona"/)
  assert.match(star, /visualRole: 'stellar-memory-photosphere-corona'/)
  assert.match(star, /planetLikeSurface: false/)
  assert.doesNotMatch(star, /life-map-weathered-memory-outcrop|<MemorySurfaceMaterial/)
