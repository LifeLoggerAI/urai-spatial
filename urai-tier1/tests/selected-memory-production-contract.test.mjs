...
test('Focus is an explorable authored living memory chamber rather than a static composited page', () => {
  ...
  assert.match(focus, /const seedGeometry = useMemo\(\(\) => \{/)
  assert.match(focus, /new THREE\.IcosahedronGeometry\(1, 5\)/)
  assert.match(focus, /focus-v217-single-connected-memory-manifestation/)
  assert.match(focus, /v217-single-rooted-manifestation-no-clone-cluster/)
  assert.match(focus, /<meshStandardMaterial vertexColors/)
