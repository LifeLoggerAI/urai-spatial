...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v378-organic-streamer-corona-photosphere-stellar-memory-field"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-organic-streamer-corona-photosphere-stellar-field-v378"/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:30%;height:30%/)
  ...
  assert.match(focus, /opacity:\.48;filter:saturate\(\.82\)/)
  assert.match(focus, /focusMemoryVisual::before/)
  assert.match(focus, /mix-blend-mode:screen;opacity:\.32;z-index:4/)
  ...
  assert.match(focus, /\.focusFallbackStar\{[^}]*width:min\(36vw,280px\)/)
  ...
  assert.match(focus, /box-shadow:0 0 12px rgba\(255,245,204,\.28\),0 0 28px rgba\(255,137,35,\.16\);clip-path:circle\(49% at 50% 50%\)/)
