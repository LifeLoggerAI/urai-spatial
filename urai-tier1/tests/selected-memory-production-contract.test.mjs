...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v361-stellar-photosphere-memory-aperture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-stellar-photosphere-owned-v361"/)
  ...
  assert.match(focus, /width:204px;height:136px/)
  assert.match(focus, /focusStarMemoryButton\{width:172px;height:116px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:156px;height:104px\}/)
