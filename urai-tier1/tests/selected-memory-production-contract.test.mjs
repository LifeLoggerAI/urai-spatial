...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v360-stellar-photosphere-memory-aperture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-stellar-photosphere-owned-v360"/)
  ...
  assert.match(focus, /width:184px;height:164px/)
  assert.match(focus, /focusStarMemoryButton\{width:150px;height:132px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:136px;height:120px\}/)
