...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v389-stellar-photosphere-contained-memory-no-orb"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-irregular-photosphere-contained-memory-v389"/)
  ...
  assert.match(focus, /opacity:\.74;filter:saturate\(\.82\) contrast\(1\.08\) brightness\(\.82\)/)
