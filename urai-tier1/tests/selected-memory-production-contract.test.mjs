...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v368-stellar-corona-owned-irregular-memory-fracture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-irregular-coronal-photosphere-owned-v368"/)
  ...
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{0\.88\}/)
  assert.match(focus, /opacity=\{memory \? 0\.64 : 0\.16\}/)
  ...
  assert.match(focus, /width:124px;height:104px/)
  assert.match(focus, /focusStarMemoryButton\{width:112px;height:94px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:102px;height:84px\}/)
  assert.match(focus, /opacity:\.72;filter:saturate\(\.88\)/)
