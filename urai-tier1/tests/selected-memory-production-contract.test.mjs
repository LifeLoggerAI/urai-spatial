...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v356-irregular-corona-readable-memory-aperture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-irregular-corona-owned-v356"/)
  ...
  assert.match(focus, /opacity:\.78;filter:saturate\(1\.02\)/)
