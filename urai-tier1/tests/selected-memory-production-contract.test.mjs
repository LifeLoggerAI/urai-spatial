...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v367-irregular-coronal-photosphere-memory-fracture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-irregular-coronal-photosphere-owned-v367"/)
  ...
  assert.match(focus, /opacity=\{memory \? 0\.9 : 0\.16\}/)
  ...
  assert.match(focus, /mask-image:radial-gradient\(circle at 50% 50%,#000 0 44%/)
  assert.match(focus, /filter:blur\(\.9px\);opacity:\.68/)
  assert.match(focus, /width:116px;height:116px/)
  assert.match(focus, /focusStarMemoryButton\{width:104px;height:104px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:92px;height:92px\}/)
  assert.match(focus, /opacity:\.58;filter:saturate\(\.82\)/)
  assert.match(focus, /focusMemoryVisual::before/)
  assert.match(focus, /mix-blend-mode:normal;opacity:\.30;z-index:4/)
  assert.match(focus, /opacity:\.34;z-index:5/)
  assert.match(focus, /focusMemoryVisual::after/)
  assert.match(focus, /box-shadow:none;-webkit-mask-image:radial-gradient\(circle at 50% 50%,#000 0 44%/)
