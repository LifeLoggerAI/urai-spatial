...
test('Focus is an explorable authored living memory chamber rather than a static composited page', () => {
  ...
  assert.match(focus, /focus-v150-authored-depth-observatory-light/)
  assert.match(focus, /v149-no-focus-ring-cage-or-repeated-runes/)
  assert.match(focus, /new THREE\.SphereGeometry\(0\.46, 32, 22\)/)
  assert.match(focus, /data-focus-visual-revision="v150-transparent-authored-depth-grounded-seed"/)
  assert.match(focus, /alpha: true/)
  assert.match(focus, /gl\.setClearColor\(0x020712, 0\)/)
  assert.match(focus, /scene\.background = null/)
