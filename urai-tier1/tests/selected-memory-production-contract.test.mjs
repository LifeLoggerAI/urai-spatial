...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{0\.64\}/)
  ...
  assert.match(focus, /mix-blend-mode:screen/)\n  assert.match(focus, /clip-path:polygon\(7% 31%,19% 9%/)
  assert.match(focus, /filter:blur\(\.9px\);opacity:\.68/)
  assert.match(focus, /width:108px;height:82px/)
  assert.match(focus, /focusStarMemoryButton\{width:98px;height:76px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:92px;height:70px\}/)
  ...
  assert.match(focus, /box-shadow:none;clip-path:polygon\(7% 31%,19% 9%/)
