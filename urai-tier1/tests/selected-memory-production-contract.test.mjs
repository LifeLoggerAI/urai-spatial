...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v359-mobile-readable-photosphere-owned-memory-aperture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-photosphere-owned-v359"/)
  ...
  assert.match(focus, /width:210px;height:138px/)
  assert.match(focus, /focusStarMemoryButton\{width:148px;height:98px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:132px;height:88px\}/)
