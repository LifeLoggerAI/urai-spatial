...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v392-stellar-photosphere-visible-contained-memory-no-orb"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-irregular-photosphere-visible-contained-memory-v392"/)
  ...
  assert.match(focus, /scale=\{\[2\.62, 2\.18, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.22 : \.10\}/)
  assert.match(focus, /scale=\{\[3\.18, 2\.58, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.11 : \.06\}/)
  assert.match(focus, /scale=\{\[1\.58, 1\.42, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.88 : \.05\}/)
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{\[\.18, \.16, \.15\]\}/)
  assert.match(focus, /opacity=\{memory \? 0\.07 : 0\.05\}/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:46%;height:34%/)
  ...
  assert.match(focus, /opacity:\.86;filter:saturate\(\.90\) contrast\(1\.12\) brightness\(\.90\)/)
