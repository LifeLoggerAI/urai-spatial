...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v372-explicit-starburst-photosphere-stellar-memory-field"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-explicit-starburst-photosphere-stellar-field-v372"/)
  ...
  assert.match(focus, /opacity:\.72;filter:saturate\(\.9\)/)
  ...
  assert.match(focus, /\.focusStarMemoryButton::before\{[^}]*clip-path:polygon\(50% 0,55% 39%/)
  assert.match(focus, /\.focusStarMemoryButton::after\{[^}]*clip-path:polygon\(50% 1%,57% 38%/)
