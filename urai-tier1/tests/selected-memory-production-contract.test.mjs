...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v362-photospheric-memory-disc"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-photospheric-memory-disc-v362"/)
  ...
  assert.match(focus, /opacity:\.94;filter:saturate\(1\.14\)/)
  assert.match(focus, /focusMemoryVisual::after/)
  assert.match(focus, /box-shadow:inset 0 0 16px rgba\(255,250,220,\.72\)/)
