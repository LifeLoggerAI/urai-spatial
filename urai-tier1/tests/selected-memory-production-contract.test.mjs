...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v376-filament-plasma-corona-photosphere-stellar-memory-field"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-filament-plasma-corona-photosphere-stellar-field-v376"/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:34%;height:34%/)
  ...
  assert.match(focus, /opacity:\.24;z-index:5/)
  ...
  assert.match(focus, /box-shadow:0 0 14px rgba\(255,245,204,\.32\),0 0 32px rgba\(255,137,35,\.18\);clip-path:circle\(49% at 50% 50%\)/)
