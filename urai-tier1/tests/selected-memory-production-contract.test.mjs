...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v388-stellar-memory-no-planet-horizon"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-irregular-photosphere-stellar-field-v388"/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:40%;height:28%/)
  ...
  assert.match(focus, /opacity:\.90;filter:saturate\(\.96\) contrast\(1\.22\) brightness\(\.96\)/)
