...
test('Focus is an explorable authored living memory chamber rather than a static composited page', () => {
  ...
  assert.match(focus, /data-focus-composition="authored-floor-with-dominant-living-memory-tree-manifestation"/)
  ...
  assert.match(focus, /data-focus-visual-revision="v250-dominant-living-memory-tree-manifestation"/)
