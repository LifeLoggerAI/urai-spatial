...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v369-corona-dominant-stellar-memory-field"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-dominant-stellar-field-v369"/)
  ...
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{0\.58\}/)
  assert.match(focus, /opacity=\{memory \? 0\.30 : 0\.16\}/)
