...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v351-corona-owned-stellar-core-memory-within"/)
  ...
  assert.match(focus, /opacity=\{memory \? 0\.82 : 0\.22\}/)
  assert.match(focus, /depthWrite=\{false\}/)
  assert.doesNotMatch(focus, /opacity=\{memory \? 0\.96 : 0\.18\}|opacity=\{memory \? 0\.26 : 0\.16\}/)
