...
test('Focus is an explorable authored living memory chamber rather than a static composited page', () => {
  ...
  assert.match(focus, /data-focus-composition="authored-floor-with-grounded-mineral-light-memory-manifestation"/)
  ...
  assert.match(focus, /data-focus-visual-revision="v249-grounded-mineral-light-memory-manifestation"/)
