...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v364-stellar-surface-stacked-over-memory"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-stellar-surface-stacked-v364"/)
  ...
  assert.match(focus, /width:184px;height:176px/)
  assert.match(focus, /focusStarMemoryButton\{width:160px;height:154px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:148px;height:142px\}/)
  assert.match(focus, /opacity:\.94;filter:saturate\(\.92\)/)
  assert.match(focus, /focusMemoryVisual::before/)
  assert.match(focus, /opacity:\.72;z-index:4/)
  assert.match(focus, /opacity:\.78;z-index:5/)
