...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /clip-path:circle\(48% at 50% 50%\)/)
  ...
  assert.match(focus, /opacity:\.78;filter:saturate\(\.88\)/)
  assert.match(focus, /focusMemoryVisual::before/)
  assert.match(focus, /mix-blend-mode:normal;opacity:\.52;z-index:4/)
  assert.match(focus, /opacity:\.64;z-index:5/)
  assert.match(focus, /focusMemoryVisual::after/)
  assert.match(focus, /box-shadow:none;clip-path:circle\(48% at 50% 50%\)/)
