...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v366-3d-photosphere-owned-memory-window"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-3d-photosphere-owned-v366"/)
  ...
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{0\.76\}/)
  assert.match(focus, /opacity=\{memory \? 0\.86 : 0\.16\}/)
  ...
  assert.match(focus, /width:126px;height:104px/)
  assert.match(focus, /focusStarMemoryButton\{width:112px;height:94px\}/)
  assert.match(focus, /focusStarMemoryButton\{width:104px;height:86px\}/)
  assert.match(focus, /opacity:\.94;filter:saturate\(\.92\)/)
