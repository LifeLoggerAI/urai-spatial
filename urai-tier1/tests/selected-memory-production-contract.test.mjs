...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v379-organic-streamer-corona-photosphere-stellar-memory-field"/)
  ...
  assert.match(focus, /scale=\{\[4\.80, 4\.35, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.82 : \.07\}/)
  assert.match(focus, /scale=\{\[5\.70, 4\.15, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.28 : \.035\}/)
  assert.match(focus, /scale=\{\[3\.00, 2\.78, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.70 : \.12\}/)
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{\[1\.12, 1\.04, 0\.96\]\}/)
  assert.match(focus, /opacity=\{memory \? 0\.44 : 0\.14\}/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:62%;height:54%/)
  ...
  assert.match(focus, /width:196px;height:196px/)
  ...
  assert.match(focus, /opacity:\.68;filter:saturate\(\.86\)/)
  ...
  assert.match(focus, /\.focusFallbackStar\{[^}]*width:min\(36vw,300px\)/)
