...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v357-asymmetric-corona-readable-memory-aperture"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-asymmetric-corona-owned-v357"/)
  ...
  assert.match(focus, /width:176px;height:112px/)
