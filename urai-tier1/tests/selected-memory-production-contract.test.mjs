...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v382-corona-plasma-photosphere-contained-memory-field"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-photosphere-stellar-field-v382"/)
  ...
  assert.match(focus, /scale=\{\[5\.40, 4\.70, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? 1 : \.10\}/)
  assert.match(focus, /scale=\{\[7\.40, 5\.60, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.92 : \.06\}/)
  assert.match(focus, /scale=\{\[1\.24, 1\.12, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.10 : \.05\}/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:74%;height:50%/)
  assert.match(focus, /focusMemoryVisual\{[^}]*border-radius:28% 72% 35% 65%/)
  ...
  assert.match(focus, /opacity:\.66;filter:saturate\(\.80\)/)
