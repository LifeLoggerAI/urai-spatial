...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v380-corona-plasma-photosphere-contained-memory-field"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-photosphere-stellar-field-v380"/)
  ...
  assert.match(focus, /focusMemoryVisual\{[^}]*width:72%;height:62%/)
