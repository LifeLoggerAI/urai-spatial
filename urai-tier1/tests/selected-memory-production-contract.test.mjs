...
test('Focus resolves the selected Life Map star into a memory-containing close-up rather than terrain', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v363-stellar-surface-over-memory"/)
  ...
  assert.match(focus, /data-focus-stellar-treatment="selected-sphere-hidden-stellar-surface-over-memory-v363"/)
