...
test('V155 keeps responsive framing with embedded fissure scars and a contained no-pedestal memory core', () => {
  ...
  assert.match(art, /for \(let index = 0; index < 120; index \+= 1\)/)
  ...
  assert.match(art, /visualIteration: 'v155-contained-memory-core-embedded-rifts-background-scans'/)
