...
test('public Focus route describes selected-memory Focus rather than historical productivity Focus', () => {
...
test('legacy session-shaped compatibility route redirects valid stars and exposes canonical unavailable copy', () => {
...
test('internal chamber/aperture names may remain while the visible Replay action stays Enter Replay', () => {
