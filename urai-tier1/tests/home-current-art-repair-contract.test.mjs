...
test('current Home candidate restores the authoritative sculpted sanctuary layer and retires the failed residence rewire', () => {
  ...
  assert.match(owner, /semanticOwner: 'passport-proximity-bridge'/)
  assert.match(owner, /visualAuthority: false/)
  assert.match(owner, /supersededBy: 'home-first-person-passport-ownership-object'/)
})
