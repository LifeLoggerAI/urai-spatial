...
test('Focus focal authority is the V305 ground-owned jagged continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, or portable focal body', () => {
  assert.match(focus, /createFocusStrata, createFocusSurfaceMaps, createFocusGroundIncision/)
  assert.match(focus, /focus-v305-ground-owned-fissure/)
  ...
  assert.match(geology, /v305-ground-owned-jagged-fissure-buried-closed-body/)
