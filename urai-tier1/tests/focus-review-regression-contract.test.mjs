...
test('Focus focal authority is the V311 near-black pressure-void ground-owned fissure continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, twig, leaf, or portable focal body', () => {
  assert.match(focus, /createFocusStrata, createFocusSurfaceMaps, createFocusGroundIncision/)
  assert.match(focus, /focus-v311-ground-owned-near-black-pressure-void-fissure/)
  ...
  assert.match(geology, /v311-ground-owned-near-black-pressure-void-fissure-buried-closed-body/)
