...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /function makeFocusPlasmaPointTexture\(\)/)
  assert.match(focus, /function makeFocusCoronaParticleGeometry\(\)/)
  assert.match(focus, /focus-memory-star-organic-corona-particles/)
  assert.match(focus, /focus-memory-star-organic-corona-haze/)
