...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v360/)
  ...
  assert.match(focus, /scale=\{\[5\.42, 4\.72, 1\]\}/)
  ...
  assert.match(focus, /opacity=\{memory \? \.30 : \.03\}/)
  assert.match(focus, /opacity=\{memory \? \.18 : \.02\}/)
