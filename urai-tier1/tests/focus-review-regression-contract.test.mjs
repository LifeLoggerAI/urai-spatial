...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v390-stellar-photosphere-contained-memory-no-orb"/)
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-irregular-photosphere-contained-memory-v390"/)
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v390/)
