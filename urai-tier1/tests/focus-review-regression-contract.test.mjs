...
test('Focus focal authority is the V306 ground-owned broken-earth continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, or portable focal body', () => {
  assert.match(focus, /createFocusStrata, createFocusSurfaceMaps, createFocusGroundIncision/)
  assert.match(focus, /focus-v306-ground-owned-fissure/)
  ...
  assert.match(geology, /v306-ground-owned-broken-earth-fissure-buried-closed-body/)
