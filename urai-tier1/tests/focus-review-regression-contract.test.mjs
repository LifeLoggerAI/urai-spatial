...
test('Focus focal authority is the V303 ground-held continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, or portable focal body', () => {
  ...
  assert.match(geology, /v303-exact-grade-ground-owned-fissure-no-twig/)
