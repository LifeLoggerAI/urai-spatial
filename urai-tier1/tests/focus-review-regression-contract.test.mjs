...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /data-focus-visual-revision="v394-stellar-photosphere-visible-contained-memory-no-orb"/)
  assert.match(focus, /data-focus-stellar-treatment="selected-corona-plasma-irregular-photosphere-visible-contained-memory-v394"/)
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v394/)
  assert.match(focus, /geometry=\{photosphereGeometry\} scale=\{\[\.38, \.34, \.31\]\}/)
  assert.match(focus, /opacity=\{memory \? 0\.14 : 0\.05\}/)
  ...
  assert.match(focus, /scale=\{\[2\.78, 2\.34, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.30 : \.10\}/)
  assert.match(focus, /scale=\{\[3\.34, 2\.76, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.15 : \.06\}/)
  assert.match(focus, /scale=\{\[1\.82, 1\.64, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.96 : \.05\}/)
  ...
  assert.match(focus, /mix-blend-mode:screen;opacity:\.12;z-index:4/)
