...
test('Focus focal authority is the V304 ground-owned continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, or portable focal body', () => {
  assert.match(focus, /createFocusStrata, createFocusSurfaceMaps, createFocusGroundIncision/)
  assert.match(focus, /focus-v304-ground-owned-incision/)
  ...
  assert.match(geology, /v304-ground-owned-coplanar-incision-buried-closed-body/)
