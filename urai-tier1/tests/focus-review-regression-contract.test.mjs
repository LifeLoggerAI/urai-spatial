...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v359/)
  ...
  assert.match(focus, /opacity=\{memory \? \.98 : \.05\}/)
  ...
  assert.match(focus, /opacity=\{memory \? \.72 : \.04\}/)
  assert.match(focus, /opacity=\{memory \? \.42 : \.03\}/)
