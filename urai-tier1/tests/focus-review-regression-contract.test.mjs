...
test('Focus focal authority is the V318 localized three-cavity-bottom terrain-owned continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, twig, leaf, or portable focal body', () => {
  assert.match(focus, /createFocusStrata, createFocusSurfaceMaps, createFocusGroundIncision/)
  assert.match(focus, /focus-v318-localized-three-radial-pressure-cavity-bottoms/)
  ...
  assert.match(geology, /v318-three-radial-terrain-cavities-localized-bottoms-ground-blended-hairline-connector-buried-closed-body/)
