...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v362/)
  ...
  assert.match(focus, /box-shadow:0 0 18px rgba\(255,246,205,\.78\),0 0 46px rgba\(255,164,66,\.32\)/)
