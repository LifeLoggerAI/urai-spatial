...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v370/)
  ...
  assert.match(focus, /scale=\{\[5\.60, 4\.10, 1\]\}/)
  assert.match(focus, /opacity=\{memory \? \.92 : \.04\}/)
  ...
  assert.match(focus, /opacity=\{memory \? \.82 : \.02\}/)
