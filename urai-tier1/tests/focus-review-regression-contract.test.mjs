...
test('Focus focal authority is the V302 ground-held continuation of the V272 single connected living-memory fold, not rejected lamellae, shards, sphere, slab, or portable focal body', () => {
  ...
  assert.match(geology, /v302-grade-flush-dark-incision-fragmented-crust-no-raised-object/)
