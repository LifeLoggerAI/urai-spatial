...
test('Focus focal authority is the selected memory star and cannot regress to V321 terrain cavities', () => {
  assert.match(focus, /Locked product authority; V354 is the current literal-pixel implementation/)
  ...
  assert.match(focus, /selected-memory-star-resolving-through-memory-v354/)
  ...
  assert.match(focus, /width:132px;height:84px/)
  assert.match(focus, /opacity:\.58;filter:saturate\(1\.02\)/)
