...
const production = fs.readFileSync(new URL('../src/spatial/layout/HomeWorldProductionV223.tsx', import.meta.url), 'utf8')
...
assert.match(production, /data-home-visible-world="cinematic-lived-world-threshold"/)
assert.match(production, /data-home-physical-base="continuous-lived-physical-world"/)
...
assert.match(production, /HomeV225PolishV3/)
assert.match(production, /HomeLaunchSanctuaryV254/)
assert.doesNotMatch(production, /portal-ring-master-v1\.glb|home-life-map-physical-portal|<WorldPortal/)
