...
test('V303 preserves V295 watertight topology while binding the closed fissure to one exact shared world grade', () => {
  ...
  assert.match(geology, /focusCurrentVisualAuthority = 'v303-exact-grade-ground-owned-fissure-no-twig'/)
