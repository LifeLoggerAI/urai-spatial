...
test('V321 preserves the buried V295 watertight body while focal-readable separated radial basins localize near-black bottoms and ground-blend the subordinate connector', () => {
  ...
  assert.match(geology, /\{ t: -\.48, radius: \.58, depth: \.108 \}/)
  assert.match(geology, /\{ t: -\.02, radius: \.64, depth: \.122 \}/)
  assert.match(geology, /\{ t: \.42, radius: \.56, depth: \.104 \}/)
  assert.match(geology, /const connectorDepth = \.0014 \* connectorFalloff/)
  assert.match(geology, /return -Math\.min\(\.128, basinDepth \+ connectorDepth\)/)
  ...
  assert.match(geology, /const pocketHalfWidth = \.330 \* nearPocket \+ \.380 \* centerPocket \+ \.315 \* farPocket/)
  ...
  assert.match(geology, /focusIncisionAuthority = 'v321-focal-readable-localized-near-black-cavity-bottoms-ground-blended-subordinate-hairline-connector'/)
