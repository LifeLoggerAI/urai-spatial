...
test('V300 preserves V295 watertight topology while seating the dark mineral fissure to authored sanctuary ground', () => {
  ...
  assert.match(geology, /V300 responds to exact V299 pixels/)
  ...
  assert.match(geology, /const x = 1\.92 \* t/)
  assert.match(geology, /const z = -1\.23 \* t/)
  ...
  assert.match(geology, /focusLiteralPixelSuccessorV300 = 'v300-terrain-seated-continuous-dark-mineral-fissure-desktop-portrait-no-islands'/)
  assert.match(geology, /focusVisualAuthority = 'v295-sanctuary-memory-scar-volume'/)
  assert.match(geology, /focusCurrentVisualAuthority = 'v300-terrain-seated-continuous-memory-fissure'/)
