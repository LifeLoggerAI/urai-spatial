...
test('V309 preserves the buried V295 watertight body while three local dark rupture cavities retain a hairline ground-owned connector', () => {
  ...
  assert.match(geology, /focusIncisionAuthority = 'v310-three-legible-pressure-cavities-broken-mineral-rims-hairline-connector-ground-owned'/)
  ...
  assert.match(geology, /focusCurrentVisualAuthority = 'v310-ground-owned-pressure-cavity-fissure-buried-closed-body'/)
