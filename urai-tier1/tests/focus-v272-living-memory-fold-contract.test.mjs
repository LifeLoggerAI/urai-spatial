...
test('selected memory remains one connected CLOSED living-memory phenomenon rather than discrete shards, cards, or an open ribbon', () => {
  ...
  assert.match(geology, /- \.065 \* furrow/)
...
test('V299 preserves V295 watertight topology while grounding the focal event as a dark mineral fissure', () => {
  ...
  assert.match(geology, /const centerY = -1\.205/)
