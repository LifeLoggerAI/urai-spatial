...
test('V318 preserves the buried V295 watertight body while three radial basins localize near-black bottoms and ground-blend the subordinate connector', () => {
  ...
  assert.match(geology, /\{ t: -\.02, radius: \.40, depth: \.088 \}/)
  assert.match(geology, /\{ t: \.42, radius: \.34, depth: \.074 \}/)
  assert.match(geology, /const connectorDepth = \.0014 \* connectorFalloff/)
  assert.match(geology, /return -Math\.min\(\.094, basinDepth \+ connectorDepth\)/)
  ...
  assert.match(geology, /const pocketHalfWidth = \.175 \* nearPocket \+ \.205 \* centerPocket \+ \.165 \* farPocket/)
