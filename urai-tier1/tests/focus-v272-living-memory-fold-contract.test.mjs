...
test('V301 preserves V295 watertight topology while seating the dark mineral fissure to authored sanctuary ground', () => {
  ...
  assert.match(geology, /focusCurrentVisualAuthority = 'v301-ground-crack-dark-incision-no-ribbon-object'/)
