...
test("static App Router provider routes are absent", () => {
  for (const routePath of staticProviderRoutes) {
    assert.equal(fs.existsSync(routePath), false, `${routePath.pathname} must not enter the static export graph`);
  }
});
