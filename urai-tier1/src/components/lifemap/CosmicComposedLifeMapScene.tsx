...
// V278 literal-pixel repair: keep V277's accepted portrait overview depth, then
// carry the same asymmetric non-point volumetric language through selected-memory
// departure, travel, approach, and arrival instead of falling back to dark star sheet.
