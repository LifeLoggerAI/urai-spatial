...
// V272 literal-pixel repair: the Life Map remains an asymmetric personal galaxy,
// while overview framing and stellar memory hierarchy now fill authored portrait
// and desktop composition without changing the selected-memory travel origin.
