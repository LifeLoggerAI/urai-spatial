...
function shouldPlaySkyPortal(searchParams: URLSearchParams) {
  ...
  return window.sessionStorage.getItem(SKY_PORTAL_KEY) === "1";
}
...
export function LifeMapSkyPortalShell() {
  ...
  return (
    <>
      <LifeMapScene />
      {showPortal && !complete ? (
        <div className="pointer-events-none fixed inset-0 z-[80] overflow-hidden bg-[#020815] text-white" aria-hidden="true">
