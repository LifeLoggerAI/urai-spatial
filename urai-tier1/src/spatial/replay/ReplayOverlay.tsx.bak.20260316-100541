        ...
        <div style={panelStyle} onClick={(e) => e.stopPropagation()}>
              ...
              {steps.map((s, idx) => (
                <div
                  ...
                  style={{
                    height: 6,
                    borderRadius: 999,
                    background: idx <= stepIndex ? glow : "rgba(255,255,255,0.12)",
                    opacity: idx === stepIndex ? 1 : 0.5,
                    boxShadow: idx === stepIndex ? `0 0 24px ${glow}` : "none",
                  }}
                />
              ))}
            </div>
          ...
          <div style={bodyStyle}>
            <div
              style={{
                ...frameStyle,
                background: `radial-gradient(circle at 50% 30%, ${glow}33, rgba(0,0,0,0) 40%), linear-gradient(180deg, rgba(255,255,255,0.04), rgba(255,255,255,0.01))`,
              }}
            >
              <div
                style={{
