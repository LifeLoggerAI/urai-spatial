...
export const FOCUS_PHASE_DEFINITIONS: Record<FocusPhase, FocusPhaseDefinition> = {
  ...
  focus_node_hovered: {
    ...
    userVisibleUi: 'A related Life Map node is previewed while the selected memory remains anchored.',
    allowedActions: ['start_replay', 'open_detail', 'recenter_focus', 'open_life_map'],
    disabledActions: ['close_detail', 'return_to_focus'],
    requiredData: ['selected memory manifest', 'hovered node id'],
    entryTrigger: 'Pointer or keyboard focus lands on a related Life Map node.',
    ...
    errorHandling: 'Ignore invalid related-context node ids and return to focus_ready.',
  },
  focus_node_selected: {
