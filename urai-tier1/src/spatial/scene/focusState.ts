...
export const FOCUS_PHASE_DEFINITIONS: Record<FocusPhase, FocusPhaseDefinition> = {
  ...
  focus_ready: {
    ...
    exitTrigger: 'The user hovers related context, selects another node, opens detail, starts replay, recenters, or exits.',
  ...
  focus_node_hovered: {
    label: 'Related Context Preview',
    userVisibleUi: 'Related context is previewed while the selected memory remains anchored.',
    allowedActions: ['start_replay', 'open_detail', 'recenter_focus', 'open_life_map'],
    disabledActions: ['close_detail', 'return_to_focus'],
    requiredData: ['selected memory manifest', 'hovered node id'],
    entryTrigger: 'Pointer or keyboard focus lands on related context.',
    ...
    accessibilityBehavior: 'Announce the related-context preview without stealing focus from the active control.',
    errorHandling: 'Ignore invalid related-context ids and return to focus_ready.',
  },
  focus_node_selected: {
    ...
    entryTrigger: 'The user selects a Focus node from the local context.',
