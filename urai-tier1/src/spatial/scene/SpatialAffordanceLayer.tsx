      ...
      {isHome && (
        <group position={[3.2, 1.0, -6.6]} onPointerDown={onOpenLifeMap}>
          <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.14, 0]}>
            ...
            <meshBasicMaterial color="#6cc7ff" transparent opacity={0.34} toneMapped={false} />
          </mesh>
      ...
      {!isHome && (
        <group position={[-4.6, 1.35, -5.8]} onPointerDown={onBack}>
          <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.16, 0]}>
            <ringGeometry args={[0.72, 0.86, 42]} />
            <meshBasicMaterial color="#aab9ff" transparent opacity={0.28} toneMapped={false} />
          </mesh>
          <mesh>
      ...
      {canReplay && (
        <group position={[0, 1.7, -10.5]} onPointerDown={onReplay}>
          <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.18, 0]}>
            ...
            <meshBasicMaterial color="#ffe3a3" transparent opacity={0.3} toneMapped={false} />
          </mesh>
          <mesh>
