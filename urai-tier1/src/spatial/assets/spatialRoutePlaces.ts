...
export const spatialRoutePlaces: readonly SpatialRoutePlace[] = [
  { id: 'entry-chamber', routePatterns: ['/', '/spatial/ar-vr'], title: 'Entry Chamber', motion: 'default arrival, walkable hub, Ground below, Life Map above', cameraState: 'HOME', assetIds: ['entry-chamber-shell-v1', 'entry-floor-ring-v1', 'central-orb-v1', 'ground-descent-hatch-v1'] },
  ...
  { id: 'focus-star', routePatterns: ['/focus'], title: 'Focus Star', motion: 'camera flight into the selected star', cameraState: 'FOCUS', assetIds: ['star-memory-node-v1'] },
  { id: 'replay-memory', routePatterns: ['/replay'], title: 'Replay Memory Interior', motion: 'enter the selected memory with truthful source grammar', cameraState: 'REPLAY', assetIds: [] },
