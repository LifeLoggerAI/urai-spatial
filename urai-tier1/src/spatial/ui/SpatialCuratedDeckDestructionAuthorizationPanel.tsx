...
export default function SpatialCuratedDeckDestructionAuthorizationPanel() {
  ...
  const authorization = useMemo(
    () => buildSpatialCuratedDeckDestructionAuthorization({ entries: vaultEntries, activeEntryId }),
  ...
  return (
    ...
    >
      ...
      >
        Curated Deck Destruction Authorization
      </div>
...
function DestructionAuthorizationSignalRow(input: {
  signal: SpatialCuratedDeckDestructionAuthorizationSignal;
}) {
  return (
    <div
      style={{
...
function DestructionAuthorizationCheckRow(input: {
  check: SpatialCuratedDeckDestructionAuthorizationCheck;
}) {
  return (
    <div
      style={{
