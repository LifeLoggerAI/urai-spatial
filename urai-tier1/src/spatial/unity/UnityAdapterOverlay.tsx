...
export default function UnityAdapterOverlay() {
  ...
  const showDemoExportControls =
    process.env.NEXT_PUBLIC_SHOW_DEMO_EXPORT_CONTROLS === "true";
  ...
  return (
    <div
      style={{
        ...
        background:
          "linear-gradient(180deg, rgba(9,12,22,0.82), rgba(7,10,18,0.92))",
    ...
    >
      ...
      {!shouldHideExportControls ? (
        <div style={{ display: "grid", gap: 8, pointerEvents: "auto" }}>
          <button type="button" onClick={handleExportManifest}>
            Export XR manifest
          </button>

          <button type="button" onClick={handleExportTierLockBundle}>
            Export tier-lock bundle
          </button>
