 ...
 * The current anonymization authority establishes 100 users as the absolute
 * default floor and requires separately approved higher minimums whenever a
 * cell is location-sensitive or derived from sensitive inference. No caller
 * may guess or auto-fill that higher threshold here.
 */
