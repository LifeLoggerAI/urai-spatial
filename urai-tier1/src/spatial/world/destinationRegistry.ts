...
export const URAI_DESTINATION_REGISTRY: Record<UraiDestination, UraiDestinationDefinition> = {
  ...
  passport: { id: 'passport', label: 'Ownership Vault', href: '/passport', layer: 'infrastructure-world', entryPortal: 'ownership-seal', cameraCheckpoint: 'passport-arrival', environmentalForm: 'protected-vault' },
  ...
  'possible-futures': { id: 'possible-futures', label: 'Possible Futures', href: '/possible-futures', layer: 'scenario-world', entryPortal: 'scenario-threshold', cameraCheckpoint: 'possible-futures-arrival', environmentalForm: 'grounded-counterfactual-world' },
}
