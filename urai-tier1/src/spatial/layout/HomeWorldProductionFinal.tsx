...
function SanctuaryArchitecture(){const pack=useStonePack(.44,.6);return <group name="home-sanctuary-pavilion" userData={{visualOwner:'cinematic-integrated-machine-sanctuary-v38',construction:'continuous-bearing-walls-curved-vault-recessed-reliquary-cavity',visualTreatment:'v38-finished-integrated-sanctuary-candidate'}}>
...
function OrbCradle(){return <group name="home-orb-engineered-cradle" position={[0,0,-3.72]} userData={{treatment:'v39-architectural-reliquary-machine',visualTreatment:'v39-direct-floor-pier-crown-bearing-frame'}}>
