...
import launchStyles from "./HomeWorldProductionLaunch.module.css";
...
export function HomeWorldProduction() {
  return (
    <main className={styles.world} data-urai-home-production>
      ...
      <section className={launchStyles.controlStack} aria-label="URAI threshold controls">
        <details className={launchStyles.orbPanel}>
          <summary aria-label="Click the orb to open the URAI companion panel">
            <span>Orb</span>
            <strong>Open companion</strong>
          </summary>
          <div className={launchStyles.panel}>
            <p className={launchStyles.panelEyebrow}>Companion online</p>
            ...
            <div className={launchStyles.panelLinks}>
        ...
        <details className={launchStyles.avatarPanel}>
          <summary aria-label="Click the self avatar to open the life state panel">
            <span>Self</span>
            <strong>Open state</strong>
          </summary>
          <div className={launchStyles.panel}>
            <p className={launchStyles.panelEyebrow}>Private state panel</p>
      ...
      <section className={launchStyles.councilHint} aria-label="Council workforce presence">
