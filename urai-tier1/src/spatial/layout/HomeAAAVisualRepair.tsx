 ...
 * existing Passport vault and world-travel stack; it is not a portal. Before travel
 * it asks the Home controller to persist the exact live FP origin so semantic return
 * restores the prior camera/state rather than generic Home.
 */
