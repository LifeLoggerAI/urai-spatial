...
export const LIFE_MAP_UNIVERSE_NODES: LifeMapUniverseNode[] = [
  ...
  node({ id: 'morning-ritual-echo', type: 'ritual', title: 'Morning Ritual Echo', subtitle: 'A repeated grounding ritual held the day together.', dateLabel: 'This week', emotionalTone: 'ritual', emotionalIntensity: 0.46, importance: 0.68, unresolvedness: 0.08, position: [3.4, 1.1, 3.7], size: 1.08, pulseSpeed: 0.66, glyph: '✺', relatedNodeIds: ['small-morning-win', 'habit-loop-softened'], connectedTo: ['habit-loop-softened'], replayAvailable: true, locked: false, narratorLine: 'The ritual mattered because it repeated gently enough to become support.', whyThis: 'URAI surfaced this because a habit-loop signal softened near repeated rhythm and recovery context.', privacyLevel: 'demo-safe', sourceSignals: ['habit-loop', 'rhythm', 'seasonal-context'] }),
...
export const LIFE_MAP_UNIVERSE_EDGES: LifeMapUniverseEdge[] = [
  ...
  { id: 'edge-habit-2', from: 'habit-loop-softened', to: 'morning-ritual-echo', arcType: 'habit-loop', glow: '#ffe9a6', strength: 0.64 },
