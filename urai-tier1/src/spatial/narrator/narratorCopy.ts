...
const URAI_CONFIGURED_DEFAULT_VOICE_ID = process.env.NEXT_PUBLIC_URAI_ELEVENLABS_DEFAULT_VOICE_ID || "";

export const URAI_VOICE_CONFIG: Record<NarratorTone, VoiceConfig> = {
  calm: { voiceId: process.env.NEXT_PUBLIC_URAI_ELEVENLABS_CALM_VOICE_ID || URAI_CONFIGURED_DEFAULT_VOICE_ID, stability: 0.72, similarity_boost: 0.82, style: 0.16, speaking_rate: 0.88 },
  awe: { voiceId: process.env.NEXT_PUBLIC_URAI_ELEVENLABS_AWE_VOICE_ID || URAI_CONFIGURED_DEFAULT_VOICE_ID, stability: 0.66, similarity_boost: 0.8, style: 0.32, speaking_rate: 0.84 },
  tension: { voiceId: process.env.NEXT_PUBLIC_URAI_ELEVENLABS_TENSION_VOICE_ID || URAI_CONFIGURED_DEFAULT_VOICE_ID, stability: 0.48, similarity_boost: 0.76, style: 0.24, speaking_rate: 0.94 },
  grief: { voiceId: process.env.NEXT_PUBLIC_URAI_ELEVENLABS_GRIEF_VOICE_ID || URAI_CONFIGURED_DEFAULT_VOICE_ID, stability: 0.76, similarity_boost: 0.84, style: 0.12, speaking_rate: 0.78 },
  recovery: { voiceId: process.env.NEXT_PUBLIC_URAI_ELEVENLABS_RECOVERY_VOICE_ID || URAI_CONFIGURED_DEFAULT_VOICE_ID, stability: 0.68, similarity_boost: 0.8, style: 0.22, speaking_rate: 0.9 },
  neutral: { voiceId: URAI_CONFIGURED_DEFAULT_VOICE_ID, stability: 0.7, similarity_boost: 0.8, style: 0.14, speaking_rate: 0.88 },
};
...
function pickLine(moment: NarratorMoment): string {
  const options = SCRIPT_LIBRARY[moment] ?? ["The field is listening."];
...
export function buildNarratorLine(moment: NarratorMoment, emotionalState?: Partial<EmotionalState>, memoryTitle?: string | null): NarratorLine {
