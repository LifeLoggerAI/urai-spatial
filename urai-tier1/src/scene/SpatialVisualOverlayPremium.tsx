...
function BodyAvatarLayer() {
  return <div className="urai-home-silhouette" data-testid="urai-home-body-avatar" aria-hidden="true" />
}

function LifeMapPreviewLayer() {
  return <div className="urai-home-lifemap-preview" data-testid="urai-home-lifemap-preview" aria-hidden="true" />
}
...
function AscentOverlay() {
  return (
    <div className="urai-visual-overlay urai-visual-overlay--ascent" data-visual-layer="ascent" data-testid="urai-ascent-scene">
      ...
      <div className="urai-ascent-stream urai-ascent-stream--three" aria-hidden="true" />
