...
function SceneOverlayStyles() {
  return (
    <style>{`
      .urai-scene-stage canvas{opacity:1!important;pointer-events:auto!important}.urai-visual-overlay{position:absolute!important;inset:0!important;z-index:30!important;pointer-events:none!important;overflow:hidden!important;isolation:isolate!important}.urai-visual-overlay:after{content:'';position:absolute;inset:0;pointer-events:none;background:radial-gradient(circle at 50% 50%,transparent 0 48%,rgba(0,0,0,.28) 100%),linear-gradient(180deg,rgba(1,3,12,0) 62%,rgba(1,3,12,.44) 100%)}.urai-sky-click-target{z-index:38!important}.urai-camera-reset,.urai-spatial-guidance,.urai-focus-action-panel,.tier-one-route-card,.urai-hud-layer{z-index:60!important}.urai-visual-caption,.urai-scene-status{position:absolute;z-index:4;border:1px solid rgba(142,220,255,.28);background:rgba(3,7,18,.56);color:rgba(235,244,255,.86);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);box-shadow:0 18px 72px rgba(0,0,0,.26)}.urai-visual-caption{left:24px;bottom:86px;display:grid;gap:3px;padding:10px 14px;border-radius:18px}.urai-visual-caption--right{left:auto;right:24px}.urai-visual-caption strong,.urai-scene-status strong{font-size:.72rem;letter-spacing:.14em;text-transform:uppercase;color:#e0f7ff}.urai-visual-caption span,.urai-scene-status span:last-child{font-size:.72rem;color:rgba(235,244,255,.74)}.urai-scene-status{left:50%;bottom:118px;display:inline-flex;align-items:center;gap:8px;transform:translateX(-50%);padding:8px 12px;border-radius:999px}.urai-scene-status__dot{width:7px;height:7px;border-radius:999px;background:#67e8f9;box-shadow:0 0 18px rgba(103,232,249,.9)}
      .urai-visual-overlay--home{background:radial-gradient(circle at 50% 44%,rgba(160,230,255,.3),transparent 18%),radial-gradient(circle at 50% 66%,rgba(139,92,246,.24),transparent 30%),linear-gradient(180deg,#244fa9 0%,#142f73 36%,#081735 68%,#020611 100%)!important}.urai-visual-overlay--home:before,.urai-visual-overlay--life-map:before,.urai-visual-overlay--focus:before{content:'';position:absolute;inset:0;z-index:1;background-image:radial-gradient(2px 2px at 18% 28%,rgba(255,255,255,.88),transparent),radial-gradient(1px 1px at 34% 18%,rgba(255,255,255,.68),transparent),radial-gradient(2px 2px at 68% 26%,rgba(199,229,255,.86),transparent),radial-gradient(1px 1px at 82% 46%,rgba(255,255,255,.64),transparent),radial-gradient(1px 1px at 52% 36%,rgba(167,139,250,.82),transparent),radial-gradient(2px 2px at 73% 14%,rgba(255,255,255,.58),transparent),radial-gradient(1px 1px at 26% 72%,rgba(103,232,249,.64),transparent);opacity:.76}.urai-home-sky-band,.urai-home-horizon,.urai-home-cloud,.urai-home-ground,.urai-home-ground-glow,.urai-home-orb,.urai-home-compass{z-index:2}.urai-home-sky-band{position:absolute;inset:0 0 30% 0;background:radial-gradient(circle at 50% 40%,rgba(255,255,255,.24),transparent 10%),radial-gradient(circle at 50% 48%,rgba(126,205,255,.42),transparent 30%),linear-gradient(180deg,rgba(48,98,197,.86),rgba(14,32,86,.72) 58%,transparent 100%)}.urai-home-horizon{position:absolute;left:8%;right:8%;top:59%;height:2px;border-radius:999px;background:linear-gradient(90deg,transparent,rgba(103,232,249,.76),rgba(167,139,250,.58),transparent);box-shadow:0 0 34px rgba(103,232,249,.5)}.urai-home-cloud{position:absolute;height:18vh;border-radius:999px;filter:blur(28px);opacity:.48;background:rgba(174,219,255,.54);animation:uraiCloudFloat 8s ease-in-out infinite}.urai-home-cloud--one{width:58vw;left:-12vw;top:23vh}.urai-home-cloud--two{width:54vw;right:-10vw;top:33vh;background:rgba(184,164,255,.46);animation-delay:-2s}.urai-home-cloud--three{width:42vw;left:32vw;top:43vh;opacity:.28;background:rgba(103,232,249,.5);animation-delay:-4s}.urai-home-ground{position:absolute;left:-12%;right:-12%;bottom:-9%;height:39%;border-radius:50% 50% 0 0;background:radial-gradient(ellipse at 50% 0%,rgba(103,232,249,.34),transparent 42%),radial-gradient(ellipse at 50% 38%,rgba(139,92,246,.24),transparent 54%),linear-gradient(180deg,rgba(57,82,130,1),rgba(8,11,24,1));box-shadow:0 -28px 110px rgba(103,232,249,.25)}.urai-home-ground-glow{position:absolute;left:16%;right:16%;bottom:20%;height:10%;border-radius:999px;background:rgba(103,232,249,.36);filter:blur(34px)}.urai-home-orb,.urai-focus-orb{position:absolute;left:50%;top:55%;width:clamp(170px,19vw,252px);aspect-ratio:1;transform:translate(-50%,-50%)}.urai-home-orb__halo,.urai-home-orb__ring,.urai-home-orb__core,.urai-focus-orb__halo,.urai-focus-orb__ring,.urai-focus-orb__core{position:absolute;border-radius:999px}.urai-home-orb__halo,.urai-focus-orb__halo{inset:0;background:radial-gradient(circle,rgba(139,92,246,.78),rgba(103,232,249,.3) 42%,transparent 74%);filter:blur(9px);animation:uraiOrbBreath 3.2s ease-in-out infinite}.urai-home-orb__ring,.urai-focus-orb__ring{inset:-18%;border:1px solid rgba(103,232,249,.44);box-shadow:inset 0 0 38px rgba(139,92,246,.18),0 0 52px rgba(103,232,249,.22)}.urai-home-orb__core,.urai-focus-orb__core{inset:24%;background:radial-gradient(circle at 35% 28%,#fff,#d6c7ff 22%,#8b5cf6 52%,#22d3ee 100%);box-shadow:0 0 86px rgba(139,92,246,.82),0 0 170px rgba(34,211,238,.36)}.urai-home-compass{position:absolute;left:18px;bottom:18px;display:grid;place-items:center;width:28px;height:28px;border-radius:999px;border:1px solid rgba(142,220,255,.28);background:rgba(3,7,18,.54);color:rgba(235,244,255,.88);font-size:.78rem}
...
function HomeOverlay() {
  return (
    <div className="urai-visual-overlay urai-visual-overlay--home" aria-hidden="true" data-visual-layer="home" data-testid="urai-home-scene">
      <SceneOverlayStyles />
      <div className="urai-home-sky-band"/><div className="urai-home-horizon"/><div className="urai-home-cloud urai-home-cloud--one"/><div className="urai-home-cloud urai-home-cloud--two"/><div className="urai-home-cloud urai-home-cloud--three"/><div className="urai-home-ground"/><div className="urai-home-ground-glow"/>
      <div className="urai-home-orb" data-testid="urai-orb-button"><div className="urai-home-orb__halo"/><div className="urai-home-orb__ring"/><div className="urai-home-orb__core"/></div>
      <div className="urai-home-compass">N</div>
      <div className="urai-visual-caption"><strong>Inner Weather</strong><span>Your companion is listening</span></div>
