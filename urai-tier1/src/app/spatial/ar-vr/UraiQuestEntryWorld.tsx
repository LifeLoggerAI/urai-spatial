...
import { UraiXrWorldRuntime, XR_PORTALS, type XrSessionLike } from './xrWorldRuntime'

export default function UraiQuestEntryWorld() {
  ...
  return (
    <section className={styles.world} data-testid="urai-quest-explorable-world" data-quest-proof="QUEST_IMMERSIVE_ENTRY_VERIFIED_MINIMAL_SHELL" aria-label="URAI explorable XR entry world">
      ...
      <div className={styles.controls} aria-label="XR and comfort controls">
        <QuestVrEntryButton onSessionRequested={attachSession} onSessionEnded={() => setMessage('Immersive session ended safely. Your chamber remains available.')} />
