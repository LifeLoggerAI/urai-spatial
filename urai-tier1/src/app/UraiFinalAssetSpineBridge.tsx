...
const finalAssetRoutes: FinalAssetRoute[] = [
  ...
  { id: 'passport', tier: 'tier2', canon: 'Passport Vault', match: (pathname) => pathname.startsWith('/passport'), asset: '/assets/urai/final/tier2/passport/passport-vault-desktop.svg' },
  { id: 'council', tier: 'tier2', canon: 'Council Chamber', match: (pathname) => pathname.startsWith('/council'), asset: '/assets/urai/final/tier2/status/status-system-pulse-desktop.svg' },
  { id: 'status', tier: 'tier2', canon: 'Status Realm', match: (pathname) => pathname.startsWith('/status'), asset: '/assets/urai/final/tier2/status/status-system-pulse-desktop.svg' },
  { id: 'privacy-controls', tier: 'tier2', canon: 'Privacy Controls', match: (pathname) => pathname.startsWith('/privacy-controls') || pathname.startsWith('/privacy'), asset: '/assets/urai/final/tier2/privacy-controls/privacy-controls-desktop.svg' },
  { id: 'location-map', tier: 'tier2', canon: 'Location Map', match: (pathname) => pathname.startsWith('/location-map'), asset: '/assets/urai/final/tier2/location-map/location-map-desktop.svg' },
  { id: 'xr', tier: 'tier3', canon: 'XR Preview', match: (pathname) => pathname.startsWith('/spatial/ar-vr') || pathname.startsWith('/spatial'), asset: '/assets/urai/final/tier3/xr/xr-preview-desktop.svg' },
  { id: 'demo', tier: 'tier3', canon: 'Demo Film', match: (pathname) => pathname.startsWith('/demo'), asset: '/assets/urai/final/tier3/demo/demo-replay-film-poster.svg' },
]
