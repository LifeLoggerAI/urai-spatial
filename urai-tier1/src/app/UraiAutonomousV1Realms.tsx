...
const realms: Record<string, RealmConfig> = {
  ...
  status: {
    ...
    accents: [{ src: statusAssets.accents.healthPill.src, alt: "Launch health signal" }],
    statement: {
      title: "One connected route",
      detail: "Core experience, consent boundaries, and production proof stay visible together.",
    },
