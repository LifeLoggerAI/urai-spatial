  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        @media(max-width:700px){.ground-authored-art{background-image:linear-gradient(180deg,rgba(1,6,17,.1),rgba(1,6,17,.22) 50%,rgba(1,6,17,.7)),var(--ground-provider-mobile);background-position:center 44%}.ground-title{top:max(15px,env(safe-area-inset-top));left:max(16px,env(safe-area-inset-left))}.ground-title strong{font-size:18px}.ground-title em{max-width:260px}.ground-movement-prompt{bottom:max(238px,calc(env(safe-area-inset-bottom) + 228px));min-width:min(320px,calc(100vw - 24px))}.ground-destination-compass{justify-content:flex-start;bottom:max(10px,env(safe-area-inset-bottom));gap:5px;padding-inline:12px 210px;scroll-padding-inline:12px 210px}.ground-destination-compass :is(a,button){min-height:48px;max-width:46px;padding:7px 10px;font-size:9px}.ground-destination-compass :is(a,button):hover,.ground-destination-compass :is(a,button):focus-visible,.ground-destination-compass :is(a,button)[aria-current]{max-width:190px}:global(.ground-active-label){min-width:160px;max-width:220px;padding:10px 12px}}
