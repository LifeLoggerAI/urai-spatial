  ...
  return (
    <main className="ground-spatial-root" aria-label="URAI Ground private workforce chamber" data-canonical-asset={groundAssets.primary.src} data-testid="urai-ground-private-workforce-world">
      ...
      <style jsx>{`
        ...
        .ground-rail::-webkit-scrollbar{display:none}.ground-rail-item{display:inline-flex;flex:0 0 auto}
        ...
        :global(.ground-district-label strong){font-size:10px;text-transform:uppercase;letter-spacing:.1em}:global(.ground-district-label em){font-style:normal;font-size:9px;color:rgba(235,244,255,.64)}
        :global(.ground-district-label.council){min-width:132px;border-color:rgba(103,232,249,.4)}
        @media(max-width:760px){.ground-hero{left:14px;right:14px;top:14px;width:auto;padding:13px 14px}.ground-hero h1{font-size:30px}.ground-hero span{font-size:12px;max-width:32ch}.ground-status,.ground-pins{display:none}.ground-rail{bottom:10px}:global(.ground-district-label){min-width:92px;padding:6px 7px}:global(.ground-district-label strong){font-size:8px}:global(.ground-district-label em){font-size:7px}}
