...
export const metadata: Metadata = {
  ...
  description: 'Official, factual UrAi naming, descriptions, founder and lead-engineer information, links, and status language.',
  twitter: {
    card: 'summary',
    title: 'Press and Media',
    description: 'Official, factual UrAi naming, descriptions, founder and lead-engineer information, links, and status language.',
...
export default function PressPage() {
  return (
    <PublicAuthorityShell eyebrow="Official media facts" title="UrAi press and media" intro="Use UrAi for the product name and URAI Labs for the founder-led product organization.">
      ...
      <h2>Lead Engineer</h2>
      <p>Chris Herrin is the Lead Engineer at URAI Labs and an engineering contributor to UrAi. No external social profile is represented as canonical until the identity match is separately verified and approved.</p>
