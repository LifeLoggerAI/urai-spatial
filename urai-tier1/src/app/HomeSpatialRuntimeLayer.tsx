...
const runtimeStyles = `.urai-home-spatial-runtime-layer .urai-final-home-doorways,.urai-home-spatial-runtime-layer .urai-asset-home-world>.home-semantic-navigation{display:none!important}.urai-home-spatial-runtime-layer>.home-semantic-navigation{position:absolute;z-index:47;left:max(12px,env(safe-area-inset-left));top:max(12px,env(safe-area-inset-top));display:flex;gap:6px;width:max-content;pointer-events:none;opacity:1}.urai-home-spatial-runtime-layer>.home-semantic-navigation:focus-within{opacity:1}.urai-home-spatial-runtime-layer>.home-semantic-navigation button,.urai-home-spatial-runtime-layer>.home-semantic-navigation a{display:flex;align-items:center;justify-content:center;width:64px;height:48px;min-width:48px;min-height:48px;box-sizing:border-box;padding:0 4px;border:1px solid rgba(230,246,240,.32);border-radius:14px;background:rgba(6,18,19,.92);color:#f3fbf8;font:700 12px/1 system-ui;cursor:pointer;pointer-events:auto;touch-action:manipulation;text-decoration:none}.urai-home-spatial-runtime-layer>.home-semantic-navigation button:focus-visible,.urai-home-spatial-runtime-layer>.home-semantic-navigation a:focus-visible{outline:2px solid #fff;outline-offset:2px}.urai-home-spatial-runtime-layer[data-webgl-ready="false"]>.home-semantic-navigation{position:absolute;left:50%;right:auto;top:auto;bottom:max(34px,calc(env(safe-area-inset-bottom) + 24px));transform:translateX(-50%);display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;width:min(760px,calc(100vw - 32px));padding:12px;border:1px solid rgba(230,246,240,.28);border-radius:22px;background:rgba(6,18,19,.92);box-shadow:0 18px 54px rgba(0,0,0,.46);pointer-events:auto;opacity:1}.urai-home-spatial-runtime-layer[data-webgl-ready="false"]>.home-semantic-navigation button,.urai-home-spatial-runtime-layer[data-webgl-ready="false"]>.home-semantic-navigation a{width:auto;height:auto;min-width:0;min-height:52px;padding:9px 12px;border-radius:14px;font:700 12px/1.25 system-ui;text-align:center}.urai-home-spatial-runtime-layer>.home-runtime-loading{position:absolute;inset:0;z-index:45;display:grid;place-content:center;gap:14px;text-align:center;background:radial-gradient(circle at 50% 52%,rgba(80,139,119,.2),rgba(8,25,22,.94) 48%,#081b18 100%);color:#eef8f3;font:600 13px/1.3 system-ui;letter-spacing:.03em;pointer-events:none}.urai-home-spatial-runtime-layer>.home-runtime-loading span{width:52px;height:52px;margin:auto;border:1px solid rgba(190,232,218,.34);border-radius:50%;box-shadow:0 0 34px rgba(109,201,174,.2),inset 0 0 22px rgba(109,201,174,.12);animation:home-runtime-forming-breath 1.8s ease-in-out infinite}@keyframes home-runtime-forming-breath{50%{transform:scale(1.08);opacity:.68}}@media(max-width:700px){.urai-home-spatial-runtime-layer[data-webgl-ready="false"]>.home-semantic-navigation{left:16px;right:16px;bottom:max(18px,calc(env(safe-area-inset-bottom) + 12px));transform:none;grid-template-columns:repeat(2,minmax(0,1fr));width:auto}}@media(prefers-reduced-motion:reduce){.urai-home-spatial-runtime-layer>.home-runtime-loading span{animation:none}}`
...
export default function HomeSpatialRuntimeLayer() {
  ...
  return (
    <section
      ...
      data-home-authored-embodied-self="camera-only-first-person-home"
