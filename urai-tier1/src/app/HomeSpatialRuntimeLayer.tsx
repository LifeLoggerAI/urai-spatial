...
import { requestHomeAvatarActivation } from '@/spatial/home/homeSemanticEvents'
...
function HomeSemanticNavigation() {
  return (
    <nav className="home-semantic-navigation" aria-label="Accessible Home destinations" data-home-navigation-owner="runtime-boundary" data-home-navigation-non-dominant="true">
      <button type="button" aria-label="Enter first-person Home" data-testid="home-semantic-avatar" data-urai-audit-action="home-avatar-first-person" onClick={requestHomeAvatarActivation}>Enter first-person Home</button>
