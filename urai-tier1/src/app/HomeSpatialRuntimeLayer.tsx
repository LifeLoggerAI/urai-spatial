...
import { requestHomeAvatarActivation } from '@/spatial/home/homeExperienceEvents'
...
function HomeSemanticNavigation() {
  return (
    <nav className="home-semantic-navigation" aria-label="Accessible Home destinations" data-home-navigation-owner="runtime-boundary" data-home-navigation-non-dominant="true">
      <button type="button" aria-label="Enter first-person Home through your Avatar" data-testid="home-semantic-avatar" data-urai-audit-action="home-avatar-embody" onClick={requestHomeAvatarActivation}>Avatar</button>
...
export default function HomeSpatialRuntimeLayer() {
  ...
  if (webglAvailable === null) {
    return (
      <section className="urai-home-spatial-runtime-layer" data-testid="urai-home-webgl-detecting" data-webgl-state="detecting" data-urai-home-runtime="accessible-boundary-while-detecting-webgl" data-webgl-ready="recovering" aria-label="URAI Home startup">
        <div role="status" aria-live="polite" className="sr-only">Detecting spatial rendering support. Accessible Home controls remain available.</div>
  ...
  if (webglAvailable === false || rendererState === 'failed') {
    ...
    return (
      <section className="urai-home-spatial-runtime-layer" data-testid="urai-home-accessible-fallback" data-webgl-state={unavailable ? 'unavailable' : 'renderer-failed'} data-urai-home-runtime={unavailable ? 'accessible-fallback-without-webgl' : 'accessible-fallback-after-renderer-failure'} data-webgl-ready="false" aria-label="Spatial Home fallback">
        <div role="status" aria-live="polite" className="sr-only">{unavailable ? 'WebGL is unavailable. Accessible Home controls remain available.' : 'The spatial renderer could not recover. Accessible Home controls remain available.'}</div>
        <HomeSemanticNavigation />
  ...
  return (
    <section ref={runtimeRef} className="urai-home-spatial-runtime-layer" data-urai-home-runtime="asset-driven-primary-with-procedural-degraded-fallback" data-home-visual-owner="asset-driven-personalized-sanctuary" data-home-authored-terrain="home-authored-terrain" data-home-authored-embodied-self="home-authored-embodied-self" data-home-exploration="walkable" data-home-ground-affordance="home-ground-environmental-threshold" data-home-life-map-affordance="home-life-map-sky-lookout" data-home-context-owner="world-local-context-only" data-webgl-state={rendererState} data-webgl-recovery-attempts={recoveryAttemptsRef.current} data-webgl-ready={rendererState === 'ready' ? 'true' : 'recovering'} aria-label="URAI living spatial Home">
