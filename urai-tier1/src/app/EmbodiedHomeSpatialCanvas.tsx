  ...
  return (
    ...
    >
      ...
      <style jsx>{`
        ...
        @media(max-width:700px){.urai-home-embodied-art{background-image:linear-gradient(180deg,rgba(1,6,14,.04),rgba(1,7,14,.16) 50%,rgba(1,5,11,.74)),radial-gradient(circle at 50% 38%,rgba(126,239,245,.08),transparent 32%),var(--home-authored-mobile);background-position:calc(50% + var(--home-walk-x,0) * -.32%) calc(44% + var(--home-walk-z,0) * .14%)}.urai-home-movement-prompt{bottom:max(202px,calc(env(safe-area-inset-bottom) + 192px));min-width:min(310px,calc(100vw - 24px))}.urai-home-direct-controls{left:auto;right:max(9px,env(safe-area-inset-right));bottom:max(9px,env(safe-area-inset-bottom));max-width:calc(100vw - 18px);overflow-x:auto}.urai-home-direct-controls button{min-height:48px;padding:0 12px}}
