 ...
 * still lack a route-owned canonical client. Privacy Controls is route-owned
 * and excluded from this layer. Passport and Location Map are likewise
 * route-owned; Mirror remains the only legacy realm here.
 */
