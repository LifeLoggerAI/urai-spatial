...
@media(max-width:760px){.replayPreflight{grid-template-columns:1fr}.providerEvidencePreview{min-height:190px}.preflightBody{padding:18px}.preflightBody dl{grid-template-columns:1fr}.preflightBody fieldset{grid-template-columns:1fr}.caption{display:none}.controls{bottom:max(205px,calc(env(safe-area-inset-bottom) + 199px))}.truthControls{left:9px;right:9px;bottom:112px}.sensoryControls{right:9px;bottom:62px}.evidencePanel,.sourceLedger,.transcript{left:12px;right:12px;top:auto;bottom:165px;width:auto}}
