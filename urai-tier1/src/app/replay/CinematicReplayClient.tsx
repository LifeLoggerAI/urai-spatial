...
export default function CinematicReplayClient() {
  ...
  return <main className="replayWorld" style={style} data-testid="cinematic-replay-client" data-memory-status={result.status} data-memory-id={memory.id} data-playing={playing} data-replay-saved={operations.saved} data-replay-hidden={operations.hidden} data-pending-operations={operations.pending.length}>
