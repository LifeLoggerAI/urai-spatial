        ...
        <section className="replayPreflight" aria-labelledby="replay-preflight-title" data-testid="replay-preflight">
          ...
          <div className="preflightBody">
            ...
            <dl>
              ...
              <div><dt>Sensitive topics</dt><dd>{sceneModel.sensitiveTopics.length ? sceneModel.sensitiveTopics.join(', ') : 'None detected'}</dd></div>
            </dl>
            <div className="disclosures" role="note">
              {sceneModel.preflightDisclosures.map((disclosure) => <p key={disclosure}>{disclosure}</p>)}
            </div>
            <fieldset>
