...
import { HomeV74RetainedPixelWorld } from '@/spatial/layout/HomeWorldProductionV74'
...
export default function AssetDrivenHomeWorld({ onOrbOpen, webglAvailable }: Props) {
  ...
  useEffect(() => {
    ...
    const hardenHomeOwnership = () => {
      ...
      world.setAttribute('data-home-v74-art-layer', 'photogrammetry-relic-sanctuary')
      world.setAttribute('data-home-v74-certification', 'retained-pixel-candidate-not-certified')
