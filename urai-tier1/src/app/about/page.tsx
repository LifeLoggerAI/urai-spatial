...
export default function AboutPage() {
  return (
    <PublicAuthorityShell eyebrow="Official product overview" title="What is UrAi?" intro="UrAi is a privacy-first personal intelligence platform by URAI Labs. It explores how memories, relationships, places, reflection, and personal direction can become a navigable spatial world.">
      ...
      <p>UrAi is the product. URAI Labs is the founder-led product organization. Adam Clamp is the Founder, Steward and System Architect. Chris Herrin is the Founding Engineer. URAI Foundation was filed in Texas as a Domestic Nonprofit Corporation and is currently recorded by the Texas Secretary of State as involuntarily terminated; no current active, good-standing, charitable, tax-exempt, donation-deductible, or fundraising-authority status is claimed.</p>
      <p>The Founding Engineer title alone does not establish equity ownership, officer/director status, legal co-founder status, or employment classification.</p>
