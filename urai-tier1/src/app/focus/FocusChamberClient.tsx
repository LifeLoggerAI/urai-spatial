...
// Locked product authority; V340 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v340',
  ...
  >
    ...
    <mesh raycast={() => null} scale={0.72} name="focus-memory-star-outer-corona">
      ...
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0 : 0.002} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={0.54} name="focus-memory-star-inner-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={light} transparent opacity={memory ? 0 : 0.003} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    ...
    <mesh raycast={() => null} scale={0.58} name="focus-memory-star-interior-depth">
      ...
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0 : 0.020} depthWrite={false} side={THREE.BackSide} blending={THREE.AdditiveBlending} />
    </mesh>
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v340-selected-star-resolving-through-memory"
