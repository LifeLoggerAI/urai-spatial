...
function FocusMemoryStar({
  ...
  >
    <sprite raycast={() => null} position={[-.12, .08, -.22]} scale={[3.65, 3.65, 1]} name="focus-memory-star-corona-glow">
      <spriteMaterial map={coronaTexture} color={accent} transparent opacity={memory ? .22 : .05} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[.10, -.05, -.08]} scale={[3.22, 3.22, 1]} rotation={.22} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color={light} transparent opacity={memory ? .20 : .05} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <mesh raycast={() => null} scale={1.34} name="focus-memory-star-outer-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.028 : 0.006} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={1.18} name="focus-memory-star-inner-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={light} transparent opacity={memory ? 0.042 : 0.008} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={1.03} name="focus-memory-star-photosphere-core">
      ...
      <meshStandardMaterial
        color={light}
        emissive={accent}
        emissiveIntensity={memory ? 1.65 : 0.20}
        roughness={0.34}
        metalness={0}
        transparent
    ...
    >
      ...
      <meshPhysicalMaterial
        color={light}
        emissive={accent}
        emissiveIntensity={memory ? (hovered ? 0.72 : 0.46) : 0.24}
        transmission={0.12}
        thickness={0.18}
        roughness={0.36}
        metalness={0}
        transparent
        opacity={memory ? 0.055 : 0.09}
        clearcoat={0.34}
    ...
    <Html center transform position={[0, 0, 0.58]} distanceFactor={4.90} zIndexRange={[20, 10]}>
      <button
        type="button"
