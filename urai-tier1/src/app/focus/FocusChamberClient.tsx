...
function FocusMemoryStar({
  ...
  >
    ...
    <sprite raycast={() => null} position={[.04, -.02, -.10]} scale={[3.36, 3.18, 1]} rotation={.19} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color="#fff0c0" transparent opacity={memory ? .46 : .04} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    ...
    <Html center transform position={[0, 0, 0.12]} distanceFactor={4.2} zIndexRange={[20, 10]}>
      <button
        type="button"
