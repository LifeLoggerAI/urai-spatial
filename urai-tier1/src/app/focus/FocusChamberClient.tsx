...
// Locked product authority; V365 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v365',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v365-granular-photosphere-over-memory"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-granular-photosphere-v365"
