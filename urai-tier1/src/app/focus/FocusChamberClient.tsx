...
// Locked product authority; V357 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v357',
  ...
  >
    ...
    <sprite raycast={() => null} position={[.04, -.03, .11]} scale={[5.72, 4.68, 1]} rotation={.19} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color="#ffe09a" transparent opacity={memory ? .72 : .04} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.04, .04, .10]} scale={[5.08, 5.64, 1]} rotation={-.43} name="focus-memory-star-photosphere-rays-secondary">
      <spriteMaterial map={rayTexture} color="#fff7dc" transparent opacity={memory ? .42 : .03} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v357-asymmetric-corona-readable-memory-aperture"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-asymmetric-corona-owned-v357"
