...
function FocusMemoryStar({
  ...
  >
    <>
    <sprite raycast={() => null} position={[-.08, .05, -.24]} scale={[4.15, 4.15, 1]} name="focus-memory-star-corona-glow">
      <spriteMaterial map={coronaTexture} color={accent} transparent opacity={memory ? .68 : .05} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[.06, -.03, -.10]} scale={[3.62, 3.62, 1]} rotation={.22} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color={light} transparent opacity={memory ? .46 : .05} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <mesh raycast={() => null} scale={0.72} name="focus-memory-star-outer-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.035 : 0.002} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={0.54} name="focus-memory-star-inner-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={light} transparent opacity={memory ? 0.065 : 0.003} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={0.31} name="focus-memory-star-photosphere-core">
      ...
      <meshStandardMaterial
        color={light}
        emissive={accent}
        emissiveIntensity={memory ? 2.45 : 0.20}
        roughness={0.66}
        metalness={0}
        transparent
        opacity={memory ? 0.34 : 0.18}
        depthWrite={false}
      />
    </mesh>
    </>
    ...
    <pointLight color={accent} intensity={memory ? 1.75 : .9} distance={7.2} decay={2} />
