...
// Locked product authority; V378 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v378',
  ...
  >
    ...
    <sprite raycast={() => null} position={[-.04, .02, .08]} scale={[6.40, 5.80, 1]} rotation={.12} name="focus-memory-star-organic-streamer-field">
      <spriteMaterial map={rayTexture} color="#ffd28a" transparent opacity={memory ? .18 : .025} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    ...
    <sprite raycast={() => null} position={[.06, -.02, .11]} scale={[7.20, 3.90, 1]} rotation={.23} name="focus-memory-star-corona-streamer-primary">
      <spriteMaterial map={rayTexture} color="#ffe09a" transparent opacity={memory ? .20 : .03} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    ...
    <sprite raycast={() => null} position={[.02, .01, .13]} scale={[6.00, 3.00, 1]} rotation={.72} name="focus-memory-star-corona-streamer-diagonal-a">
      <spriteMaterial map={rayTexture} color="#ffd07a" transparent opacity={memory ? .14 : .018} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.03, .02, .14]} scale={[5.70, 2.85, 1]} rotation={-.91} name="focus-memory-star-corona-streamer-diagonal-b">
      <spriteMaterial map={rayTexture} color="#fff0b8" transparent opacity={memory ? .12 : .018} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.02, .01, .12]} scale={[6.40, 5.40, 1]} rotation={.13} name="focus-memory-star-photosphere-surface">
      <spriteMaterial map={photosphereTexture} color="#ffe7aa" transparent opacity={memory ? .92 : .14} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[.03, -.02, .16]} scale={[5.80, 4.70, 1]} rotation={-.16} name="focus-memory-star-white-hot-limb">
      <spriteMaterial map={photosphereTexture} color="#fffbe8" transparent opacity={memory ? .55 : .08} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <group raycast={() => null} name="focus-memory-star-explicit-corona-rays" position={[0, 0, -0.04]} />
    <mesh raycast={() => null} geometry={photosphereGeometry} scale={[1.10, 0.95, 0.70]} name="focus-memory-star-photosphere-core" rotation={[0.08, -0.18, 0]}>
      <meshBasicMaterial
        map={sphereTexture}
        color="#fff3b8"
        transparent
        opacity={memory ? 0.72 : 0.16}
        depthWrite={false}
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v378-organic-streamer-corona-photosphere-stellar-memory-field"
    ...
    data-focus-stellar-treatment="selected-organic-streamer-corona-photosphere-stellar-field-v378"
