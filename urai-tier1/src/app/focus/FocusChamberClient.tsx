...
// Locked product authority; V358 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v358',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v358-photosphere-owned-memory-aperture"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-photosphere-owned-v358"
