...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v354',
  ...
  >
    ...
    <mesh raycast={() => null} scale={0.64} name="focus-memory-star-interior-depth">
      ...
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.018 : 0.012} depthWrite={false} side={THREE.BackSide} blending={THREE.AdditiveBlending} />
    </mesh>
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v354-irregular-corona-memory-within"
