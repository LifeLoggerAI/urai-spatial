...
// Locked product authority; V359 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v359',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v359-mobile-readable-photosphere-owned-memory-aperture"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-photosphere-owned-v359"
