...
// Locked product authority; V337 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v337',
  ...
  >
    ...
    <mesh raycast={() => null} scale={0.58} name="focus-memory-star-interior-depth">
      ...
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.018 : 0.020} depthWrite={false} side={THREE.BackSide} blending={THREE.AdditiveBlending} />
    </mesh>
