...
// Locked product authority; V373 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v373',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v373-organic-corona-photosphere-stellar-memory-field"
    ...
    data-focus-stellar-treatment="selected-organic-corona-photosphere-stellar-field-v373"
