...
// Locked product authority; V363 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v363',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v363-stellar-surface-over-memory"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-stellar-surface-over-memory-v363"
