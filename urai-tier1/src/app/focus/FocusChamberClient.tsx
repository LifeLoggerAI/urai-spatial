...
// Locked product authority; V377 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v377',
      lifeMapContinuity: 'same-selected-star-resolved-at-close-range',
      terrainOwner: false,
    }}
  >
    <>
    <sprite raycast={() => null} position={[-.04, .02, .08]} scale={[6.40, 5.80, 1]} rotation={.12} name="focus-memory-star-organic-streamer-field">
      <spriteMaterial map={rayTexture} color="#ffd28a" transparent opacity={memory ? .36 : .025} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.08, .04, -.08]} scale={[5.60, 4.80, 1]} rotation={-.18} name="focus-memory-star-corona-glow">
      <spriteMaterial map={coronaTexture} color="#ffbd63" transparent opacity={memory ? .68 : .04} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[.06, -.02, .11]} scale={[7.20, 3.90, 1]} rotation={.23} name="focus-memory-star-corona-streamer-primary">
      <spriteMaterial map={rayTexture} color="#ffe09a" transparent opacity={memory ? .34 : .03} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.05, .06, .10]} scale={[4.10, 6.80, 1]} rotation={-.49} name="focus-memory-star-corona-streamer-secondary">
      <spriteMaterial map={rayTexture} color="#fff7dc" transparent opacity={memory ? .30 : .02} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[.02, .01, .13]} scale={[6.00, 3.00, 1]} rotation={.72} name="focus-memory-star-corona-streamer-diagonal-a">
      <spriteMaterial map={rayTexture} color="#ffd07a" transparent opacity={memory ? .24 : .018} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.03, .02, .14]} scale={[5.70, 2.85, 1]} rotation={-.91} name="focus-memory-star-corona-streamer-diagonal-b">
      <spriteMaterial map={rayTexture} color="#fff0b8" transparent opacity={memory ? .20 : .018} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v377-organic-streamer-corona-photosphere-stellar-memory-field"
    ...
    data-focus-stellar-treatment="selected-organic-streamer-corona-photosphere-stellar-field-v377"
