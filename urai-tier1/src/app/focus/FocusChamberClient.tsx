...
// Locked product authority; V374 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  const coronaFilamentsA = useMemo(() => makeFocusCoronaFilamentGeometry(148, .34, 2.35, .17), [])
  const coronaFilamentsB = useMemo(() => makeFocusCoronaFilamentGeometry(96, .42, 1.72, 1.41), [])
  useEffect(() => () => {
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v374',
  ...
  >
    ...
    <lineSegments raycast={() => null} geometry={coronaFilamentsA} position={[0, 0, .22]} rotation={[0, 0, -.09]} name="focus-memory-star-corona-filaments-primary">
      <lineBasicMaterial color="#ffd48a" transparent opacity={memory ? .34 : .03} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </lineSegments>
    <lineSegments raycast={() => null} geometry={coronaFilamentsB} position={[0, 0, .21]} rotation={[0, 0, .31]} name="focus-memory-star-corona-filaments-secondary">
      <lineBasicMaterial color="#fff0c2" transparent opacity={memory ? .19 : .02} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </lineSegments>
    <sprite raycast={() => null} position={[-.08, .04, -.08]} scale={[5.80, 4.40, 1]} rotation={-.18} name="focus-memory-star-corona-glow">
    ...
    <sprite raycast={() => null} position={[.06, -.02, .11]} scale={[8.20, 3.10, 1]} rotation={.23} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color="#ffe09a" transparent opacity={memory ? .92 : .03} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.05, .06, .10]} scale={[3.00, 8.00, 1]} rotation={-.49} name="focus-memory-star-photosphere-rays-secondary">
      <spriteMaterial map={rayTexture} color="#fff7dc" transparent opacity={memory ? .86 : .02} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[.02, .01, .13]} scale={[6.90, 2.55, 1]} rotation={.72} name="focus-memory-star-coronal-arm-diagonal-a">
      <spriteMaterial map={rayTexture} color="#ffd07a" transparent opacity={memory ? .66 : .02} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} position={[-.03, .02, .14]} scale={[6.30, 2.20, 1]} rotation={-.91} name="focus-memory-star-coronal-arm-diagonal-b">
      <spriteMaterial map={rayTexture} color="#fff0b8" transparent opacity={memory ? .58 : .02} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v374-filament-corona-photosphere-stellar-memory-field"
    ...
    data-focus-stellar-treatment="selected-filament-corona-photosphere-stellar-field-v374"
