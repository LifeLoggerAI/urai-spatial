...
function FocusMemoryStar({
  ...
  >
    ...
    <mesh raycast={() => null} geometry={photosphereGeometry} scale={0.88} name="focus-memory-star-photosphere-core" rotation={[0.08, -0.18, 0]}>
      <meshBasicMaterial
        map={sphereTexture}
        color="#fff3b8"
        transparent
        opacity={memory ? 0.9 : 0.16}
        depthWrite={false}
