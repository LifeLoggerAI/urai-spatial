...
function FocusMemoryStar({
  ...
  >
    <>
    <sprite raycast={() => null} position={[-.08, .05, -.24]} scale={[3.55, 3.55, 1]} name="focus-memory-star-corona-glow">
    ...
    <sprite raycast={() => null} position={[.06, -.03, -.10]} scale={[3.05, 3.05, 1]} rotation={.22} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color={light} transparent opacity={memory ? .30 : .05} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
