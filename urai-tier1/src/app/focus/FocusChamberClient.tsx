...
function FocusMemoryStar({
  ...
  >
    <sprite raycast={() => null} scale={[3.95, 3.95, 1]} name="focus-memory-star-corona-glow">
      <spriteMaterial map={coronaTexture} color={accent} transparent opacity={memory ? .24 : .08} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <sprite raycast={() => null} scale={[3.10, 3.10, 1]} name="focus-memory-star-photosphere-rays">
      <spriteMaterial map={rayTexture} color={light} transparent opacity={memory ? .20 : .06} depthWrite={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
    <mesh raycast={() => null} scale={1.42} name="focus-memory-star-outer-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.052 : 0.020} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={1.20} name="focus-memory-star-inner-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={light} transparent opacity={memory ? 0.078 : 0.028} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={1.03} name="focus-memory-star-photosphere-core">
      ...
      <meshStandardMaterial
        color={light}
        emissive={accent}
        emissiveIntensity={memory ? 1.12 : 0.24}
        roughness={0.52}
        metalness={0}
        transparent
        opacity={memory ? 0.40 : 0.16}
        depthWrite={false}
      />
    </mesh>
    <mesh
    ...
    >
      ...
      <meshPhysicalMaterial
        color={light}
        emissive={accent}
        emissiveIntensity={memory ? (hovered ? 1.55 : 1.05) : 0.30}
        transmission={0.30}
        thickness={0.44}
        roughness={0.26}
        metalness={0}
        transparent
        opacity={memory ? 0.19 : 0.10}
        clearcoat={0.78}
    ...
    <pointLight color={accent} intensity={memory ? 4.8 : 1.0} distance={9.2} decay={2} />
    <Html center transform position={[0, 0, 0.72]} distanceFactor={4.35} zIndexRange={[20, 10]}>
      <button
        type="button"
