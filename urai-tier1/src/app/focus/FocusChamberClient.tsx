...
// Locked product authority; V361 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v361',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v361-stellar-photosphere-memory-aperture"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-stellar-photosphere-owned-v361"
