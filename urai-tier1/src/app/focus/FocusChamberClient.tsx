...
// Locked product authority; V382 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v382',
  ...
  >
    ...
    <sprite raycast={() => null} position={[-.01, .01, .18]} scale={[1.24, 1.12, 1]} rotation={.07} name="focus-memory-star-photosphere-surface">
      <spriteMaterial map={photosphereTexture} color="#fffbe7" transparent opacity={memory ? .10 : .05} depthWrite={false} depthTest={false} blending={THREE.AdditiveBlending} toneMapped={false} />
    </sprite>
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v382-corona-plasma-photosphere-contained-memory-field"
    ...
    data-focus-stellar-treatment="selected-corona-plasma-photosphere-stellar-field-v382"
