...
// Locked product authority; V329 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-with-contained-memory-v329',
  ...
  >
    ...
    <mesh raycast={() => null} scale={0.72} name="focus-memory-star-outer-corona">
      ...
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.018 : 0.004} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    <mesh raycast={() => null} scale={0.54} name="focus-memory-star-inner-corona">
      <sphereGeometry args={[1, 64, 40]} />
      <meshBasicMaterial color={light} transparent opacity={memory ? 0.034 : 0.006} depthWrite={false} blending={THREE.AdditiveBlending} />
    </mesh>
    ...
    <mesh raycast={() => null} scale={0.46} name="focus-memory-star-interior-depth">
      ...
      <meshBasicMaterial color={accent} transparent opacity={memory ? 0.16 : 0.020} depthWrite={false} side={THREE.BackSide} blending={THREE.AdditiveBlending} />
    </mesh>
    ...
    <Html center transform position={[0, 0, 0.31]} distanceFactor={6.8} zIndexRange={[20, 10]}>
      <button
        type="button"
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v329-additive-stellar-photosphere-contained-memory"
