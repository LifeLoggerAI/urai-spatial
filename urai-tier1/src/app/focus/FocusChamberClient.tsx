...
// Locked product authority; V355 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v355',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v355-corona-owned-memory-aperture"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-corona-owned-v355"
