...
// Locked product authority; V364 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v364',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v364-stellar-surface-stacked-over-memory"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-stellar-surface-stacked-v364"
