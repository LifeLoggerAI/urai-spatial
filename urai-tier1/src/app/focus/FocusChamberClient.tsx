...
// Locked product authority; V362 is the current literal-pixel implementation:
...
function FocusMemoryStar({
  ...
  return <group
    ...
    userData={{
      visualAuthority: 'selected-memory-star-resolving-through-memory-v362',
...
export default function FocusChamberClient() {
  ...
  return <main
    ...
    data-focus-visual-revision="v362-photospheric-memory-disc"
    ...
    data-focus-stellar-treatment="selected-sphere-hidden-photospheric-memory-disc-v362"
