    ...
    <main className="min-h-screen bg-[#020713] px-5 py-12 text-white md:px-8">
      <section className="mx-auto max-w-3xl">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-200">
          UrAi is not accepting live paid checkout from this release-candidate surface. A monitored customer-support channel and response process must be
          approved and published before live purchases are enabled.
        </p>
        <div className="mt-8 rounded-2xl border border-white/15 bg-white/[0.04] p-6 text-slate-300">
          <p>
            The launch support path must cover billing questions, cancellation and refund requests under the final published policies, account-access
            issues, and privacy requests without requiring customers to disclose passwords, payment credentials, recovery codes, or other secrets.
          </p>
        </div>
        <p className="mt-8 text-sm leading-6 text-slate-400">
          No support email or phone number is invented on this page. The verified customer-service contact will be published here before live checkout.
        </p>
