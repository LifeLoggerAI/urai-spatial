...
const passportStyle = {
  '--passport-vault-art': assetCssStack(passportAssets.primary),
} as CSSProperties

const passportArtStyle = {
  backgroundImage: 'var(--passport-vault-art)',
} as CSSProperties
...
export default function FinalPassportVault() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-cover bg-center opacity-50 mix-blend-screen brightness-75 contrast-125 saturate-150" style={passportArtStyle} />
