...
const routeAuditCommand = ['node', ['scripts/tier-lock/route-audit-final.mjs']]

const commands = {
  tier1: [routeAuditCommand, reportCommand],
  tier2: [routeAuditCommand, ['node', ['scripts/tier-lock/console-warning-audit.mjs']], reportCommand],
  tier3: [
    routeAuditCommand,
