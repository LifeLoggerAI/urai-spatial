...
if (ringRef.current) {
  ringRef.current.position.copy(orbRef.current?.position ?? ringRef.current.position);
...
>
<sphereGeometry args={[120, 48, 48]} /> <meshBasicMaterial color="#02102e" side={BackSide} /> </mesh>
