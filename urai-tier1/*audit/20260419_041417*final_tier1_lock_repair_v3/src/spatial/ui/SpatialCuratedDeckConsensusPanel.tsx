...
export default function SpatialCuratedDeckConsensusPanel() {
  ...
  const consensus = useMemo(
    () => buildSpatialCuratedDeckConsensus({ entries: vaultEntries, activeEntryId }),
    ...
    >
      ...
      <div style={{ marginTop: 10, display: "grid", gap: 8 }}>
        ...
        <ConsensusRow
          ...
          value={consensus.dominantFirstMode ?? "n/a"}
          status={consensus.activeMatchesDominantFirstMode ? "match" : "drift"}
        />
      </div>
    </div>
  );
