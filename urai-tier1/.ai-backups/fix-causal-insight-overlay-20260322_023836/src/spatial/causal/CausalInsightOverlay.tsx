...
export default function CausalInsightOverlay() {
  ...
  const state = useMemo(
    () => resolveCausalInsightById(resolveStarByIdSafe(selectedStarId)),
    [selectedStarId]
  );
    ...
    >
      ...
      <div
        style={{
          ...
          lineHeight: 1.55,
          opacity: 0.86,
          marginBottom: state.drivers.length > 0 ? 12 : 0,
        }}
      >
        {state.summary}
      </div>
      ...
      {state.drivers.length > 0 ? (
        <div
          style={{
            ...
            flexWrap: "wrap",
            gap: 8,
            marginBottom: state.hypotheses.length > 0 ? 12 : 0,
          }}
        >
      ...
      {state.hypotheses.length > 0 ? (
        <div
          style={{
            display: "grid",
            gap: 8,
            marginBottom: state.evidence.length > 0 ? 12 : 0,
          }}
        >
