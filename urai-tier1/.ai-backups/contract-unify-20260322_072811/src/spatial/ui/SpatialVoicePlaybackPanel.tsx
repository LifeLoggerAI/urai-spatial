...
export default function SpatialVoicePlaybackPanel() {
  ...
  const toSpatialCompareSetContract(activeCompareSet) = useMemo(() => {
  ...
  const exportPackage = useMemo(() => {
    ...
    const normalizedActiveCompareSet =
      toSpatialCompareSetContract(activeCompareSet);

    if (!activeLens || !normalizedActiveCompareSet) return null;
    ...
    return buildSpatialNarratorExport({
      ...
      accountLabel:
        ...
        "Default Account",
      activeLens,
      toSpatialCompareSetContract(activeCompareSet): normalizedActiveCompareSet,
