    ...
    >
      ...
      {mode === "sky" && (
        ...
        >
          ...
          <div style={{ fontSize: 34, lineHeight: 1.04, fontWeight: 700, marginBottom: 8 }}>
            Sky
          </div>
          <div
            style={{
          ...
          >
            This is transit only. Input is locked until the map settles.
          </div>
          <div
            style={{
              height: 6,
          ...
          >
            <div
              style={{
                ...
                height: "100%",
                background:
                  "linear-gradient(90deg, rgba(170,196,255,0.20) 0%, rgba(214,226,255,0.88) 100%)",
                animation: "transit-fill 950ms linear 1",
              }}
            />
          </div>
        </section>
