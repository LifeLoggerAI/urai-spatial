...
function vlerp(a: THREE.Vector3, b: THREE.Vector3, t: number) {
...
function transitionProgress(tr: TransitionState) {
...
function getStar(id: string | null) {
...
useEffect(() => { selectedRef.current = selectedStarId }, [selectedStarId])
