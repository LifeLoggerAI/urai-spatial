...
<meshBasicMaterial color="#c6a74c" transparent opacity={0.16 * replayAlpha} /> </mesh>
<mesh position={[0, 0, -0.34]}>
<circleGeometry args={[0.62, 40]} />
<meshBasicMaterial color="#11203d" transparent opacity={0.98 * replayAlpha} /> </mesh> </group>
)
}
...
<directionalLight position={[5, 12, 10]} intensity={0.82} /> <HomeWorld phase={phase} transition={transition} onSkyClick={onSkyClick} /> <LifemapWorld
     phase={phase}
