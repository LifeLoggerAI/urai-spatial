...
{ id: 'far_00', layer: 'far', position: [-17.0, 9.2, -36.0], radius: 0.04 },
{ id: 'far_01', layer: 'far', position: [-12.8, 7.8, -34.0], radius: 0.042 },
{ id: 'far_02', layer: 'far', position: [-8.2, 9.8, -35.0], radius: 0.04 },
{ id: 'far_03', layer: 'far', position: [-2.0, 11.0, -37.0], radius: 0.043 },
{ id: 'far_04', layer: 'far', position: [4.0, 10.0, -36.0], radius: 0.04 },
{ id: 'far_05', layer: 'far', position: [9.2, 8.0, -35.0], radius: 0.041 },

{ id: 'mid_00', layer: 'mid', position: [-11.0, 6.3, -21.0], radius: 0.09 },
{ id: 'mid_01', layer: 'mid', position: [-7.2, 3.9, -19.5], radius: 0.09 },
{ id: 'mid_02', layer: 'mid', position: [-3.5, 6.8, -20.5], radius: 0.095 },
{ id: 'mid_03', layer: 'mid', position: [2.1, 7.3, -22.0], radius: 0.095 },
{ id: 'mid_04', layer: 'mid', position: [7.0, 5.7, -20.5], radius: 0.095 },

{ id: 'near_00', layer: 'near', position: [-8.2, 2.0, -9.2], radius: 0.15 },
{ id: 'near_01', layer: 'near', position: [-4.0, 4.0, -8.4], radius: 0.138 },
{ id: 'near_02', layer: 'near', position: [5.5, 3.8, -9.6], radius: 0.145 },
{ id: 'near_03', layer: 'near', position: [3.5, -4.3, -8.8], radius: 0.138 },
{ id: 'near_04', layer: 'near', position: [-3.3, -4.1, -7.9], radius: 0.142 },
]
...
if (props.transition.active && props.transition.kind === 'home_to_lifemap') {
  ...
  if (p < 0.25) {
    ...
    const t = easeOutCubic(smoothstep(0.86, 1.0, p))
